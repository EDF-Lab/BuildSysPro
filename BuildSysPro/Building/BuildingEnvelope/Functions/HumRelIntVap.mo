...
function HumRelIntVap "Hrint = f(Patm,Text, Hr_ext, T_int)"
...
algorithm
  ...
  Xsi := Xse + vap*(1+Xse)/(1.24*Qv); //  Water vapor conservation
 // Hr_int :=Hr_ext;
...
<p>Internal relative humidity of vapor between 0 and 1 at constant water content.</p>
