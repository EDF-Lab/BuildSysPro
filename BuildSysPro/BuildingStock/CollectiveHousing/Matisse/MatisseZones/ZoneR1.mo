...
// Horizontal walls
  BuildSysPro.Building.BuildingEnvelope.HeatTransfer.Wall Plafond(
    ...
    S=BuildSysPro.BuildingStock.Utilities.Records.Geometry.CollectiveHousing.SettingsMatisse.Surf_PlancherPlafondC1) if not
    EmplacementHaut
...
// Glazings
  ...
  BuildSysPro.Building.BuildingEnvelope.HeatTransfer.Window VitrageNord(
    ...
    S=BuildSysPro.BuildingStock.Utilities.Records.Geometry.CollectiveHousing.SettingsMatisse.Surf_VitrageNordC1,
...
public
  ...
  BuildSysPro.BoundaryConditions.Radiation.PintRadDistrib PintdistriRad(
    ...
    Sp={BuildSysPro.BuildingStock.Utilities.Records.Geometry.CollectiveHousing.SettingsMatisse.Surf_PlancherPlafondC1,
        ...
        BuildSysPro.BuildingStock.Utilities.Records.Geometry.CollectiveHousing.SettingsMatisse.Surf_PlancherPlafondC1,
        BuildSysPro.BuildingStock.Utilities.Records.Geometry.CollectiveHousing.SettingsMatisse.Surf_PorteIntEntreeC1}) if not
    CLOintPlancher
...
public
  ...
  BuildSysPro.BaseClasses.HeatTransfer.Interfaces.HeatPort_a T_int_room1
    annotation (Placement(transformation(extent={{80,-29},{100,-9}}),
        iconTransformation(extent={{-19,-56},{1,-36}})));
  BuildSysPro.Building.AirFlow.HeatTransfer.AirRenewal renouvellementAir(
      use_Qv_in=QVin, Qv=paraMaisonRT.renouvAir*BuildSysPro.BuildingStock.Utilities.Records.Geometry.CollectiveHousing.SettingsMatisse.Surf_PlancherPlafondC1
...
if EmplacementBas==true then
  ...
  connect(noeudAir.port_a, T_int_room1) annotation (Line(
...
graphics={
        ...
        Line(
          ...
          rotation=180),
        Line(
          points={{6,54},{22,62},{36,54}},
          color={0,0,255},
          smooth=Smooth.Bezier),
        Polygon(
          points={{36,56},{38,52},{34,54},{36,56}},
          lineColor={0,0,255},
          smooth=Smooth.None,
          fillColor={0,0,255},
          fillPattern=FillPattern.Solid),
...
<p>Stéphanie Froidurot - 10/2020 : Add flux for internal doors + correction code</p>
</html>"));
end ZoneR1;
