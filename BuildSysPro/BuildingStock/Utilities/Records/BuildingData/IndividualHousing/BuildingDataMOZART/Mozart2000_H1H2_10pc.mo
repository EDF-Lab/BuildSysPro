...
record Mozart2000_H1H2_10pc =
    BuildSysPro.BuildingStock.Utilities.Records.BuildingData.IndividualHousing.BuildingDataMOZART.BuildingType
    (
    redeclare replaceable parameter
      WallData.IndividualHousing.RT2000_H1H2_10pc.AtticWall ParoiSousCombles,
    redeclare replaceable parameter
      WallData.IndividualHousing.RT2000_H1H2_10pc.Door Porte,
    redeclare replaceable parameter
      WallData.IndividualHousing.RT2000_H1H2_10pc.Floor PlancherBas,
    redeclare replaceable parameter
      WallData.IndividualHousing.RT2000_H1H2_10pc.ExtWall Mur,
    ...
    bLNC=0.95,
    bPlancher=1,
    bSousCombles=1) "Settings of Mozart individual housing 2000 CrefH1_H2 -10%"
