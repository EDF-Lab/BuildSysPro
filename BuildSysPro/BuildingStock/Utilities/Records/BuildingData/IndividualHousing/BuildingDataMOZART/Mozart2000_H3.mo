...
record Mozart2000_H3 =
    BuildSysPro.BuildingStock.Utilities.Records.BuildingData.IndividualHousing.BuildingDataMOZART.BuildingType
    (
    redeclare replaceable parameter
      WallData.IndividualHousing.RT2000_H3.AtticWall ParoiSousCombles,
    redeclare replaceable parameter WallData.IndividualHousing.RT2000_H3.Door
      Porte,
    redeclare replaceable parameter WallData.IndividualHousing.RT2000_H3.Floor
      PlancherBas,
    redeclare replaceable parameter
      WallData.IndividualHousing.RT2000_H3.ExtWall Mur,
    ...
    bLNC=0.95,
    bPlancher=1,
    bSousCombles=1) "Settings of Mozart individual housing 2000 CrefH3"
                                                      annotation (
