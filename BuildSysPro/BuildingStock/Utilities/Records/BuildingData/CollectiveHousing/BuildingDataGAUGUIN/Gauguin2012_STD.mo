...
BuildSysPro.BuildingStock.Utilities.Records.BuildingData.CollectiveHousing.BuildingDataGAUGUIN.BuildingType
    ...
    redeclare parameter WallData.CollectiveHousing.IntermediateFloor
      PlancherInterm,
    redeclare parameter WallData.CollectiveHousing.RT2012_STD.Door Porte,
    ...
    redeclare parameter WallData.CollectiveHousing.RT2012_STD.LandingWall
      MurPalier,
    redeclare parameter WallData.CollectiveHousing.RT2012_STD.ExtWall MurCage,
  ...
  "Settings of Gauguin collective housing standard 2012" annotation (
