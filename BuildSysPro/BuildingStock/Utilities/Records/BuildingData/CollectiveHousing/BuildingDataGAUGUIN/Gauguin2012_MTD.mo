...
BuildSysPro.BuildingStock.Utilities.Records.BuildingData.CollectiveHousing.BuildingDataGAUGUIN.BuildingType
    ...
    redeclare parameter WallData.CollectiveHousing.RT2012_MTD.LandingWall
      MurPalier,
    redeclare parameter WallData.CollectiveHousing.RT2012_MTD.ExtWall MurCage,
  ...
  "Settings of Gauguin collective housing best available technology 2012"
                                                         annotation (
