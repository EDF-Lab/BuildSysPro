...
record Matisse1982to1989 =
    ...
    redeclare replaceable parameter
      WallData.CollectiveHousing.From1982to1989.Door Porte,
    ...
    redeclare replaceable parameter
      WallData.CollectiveHousing.From1982to1989.ExtWall MurExt,
    redeclare replaceable parameter
      WallData.CollectiveHousing.From1982to1989.LandingWall MurPalier,
    redeclare replaceable parameter
      WallData.CollectiveHousing.From1982to1989.Ceiling PlafondImmeuble,
    redeclare replaceable parameter
      WallData.CollectiveHousing.From1982to1989.Floor PlancherImmeuble,
    ...
    hsExtHor=20,
    hsIntHorHaut=11.11)
  "Settings of Matisse collective housing from 1982 to 1989" annotation (
