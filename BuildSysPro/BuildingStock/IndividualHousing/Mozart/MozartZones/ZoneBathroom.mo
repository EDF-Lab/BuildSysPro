...
public
  ...
  BuildSysPro.BaseClasses.HeatTransfer.Interfaces.HeatPort_a T_int_bathroom
    annotation (Placement(transformation(extent={{80,-29},{100,-9}}),
        iconTransformation(extent={{-3,12},{17,32}})));
...
equation
 ...
 connect(VitrageSudSF.T_int, noeudAir.port_a) annotation (Line(
  ...
  connect(FluxIncExtSouth, VitrageSudSF.FluxIncExt) annotation (Line(
...
graphics={
        Bitmap(extent={{70,60},{-70,-60}}, fileName="modelica://BuildSysPro/Resources/Images/Batiments/Batiments types/Mozart/SDB.png",
          origin={-2,20},
          rotation=180),
