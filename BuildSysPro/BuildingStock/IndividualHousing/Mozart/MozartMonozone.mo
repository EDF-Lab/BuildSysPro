...
// Internal vertical walls
 ...
 BuildSysPro.Building.BuildingEnvelope.HeatTransfer.Wall PortesInt(
    ParoiInterne=true,
    S=BuildSysPro.BuildingStock.Utilities.Records.Geometry.IndividualHousing.SettingsMozart.Surf_PorteSeparation,
    Tp=Tp,
    InitType=InitType,
    hs_ext=paraMaisonRT.hsIntVert,
    hs_int=paraMaisonRT.hsIntVert,
...
if useOuverturePF then
  ...
  connect(T_ext, Porte.T_ext) annotation (Line(
    ...
    connect(noeudAir.port_a, PortesInt.T_ext) annotation (Line(
      points={{80,22},{64,22},{64,-28},{52.8,-28},{52.8,-23.4}}, color={191,0,0}));
    connect(PortesInt.T_int, Refends.T_ext) annotation (Line(
      points={{52.8,-12.6},{52.8,-10.3},{52.8,-10.3},{52.8,-5.4}}, color={191,0,0}));
...
<p>Parameter <span style=\"font-family: Courier New;\">paraMaisonRT</span> allows the user to chose a specific French building regulation for the building, so that building envelope parameters (walls, windows, ventilation...) will be automatically filled with data from the choosen record.</p>
<p>Parameters <span style=\"font-family: Courier New;\">renoPlafond</span>, <span style=\"font-family: Courier New;\">renoPlancher</span>, <span style=\"font-family: Courier New;\">renoFenetre</span>, and <span style=\"font-family: Courier New;\">renoMurExt</span> allow to specify which element of the building have been renovated according to the RT Existing (French building regulation for renovation by element).</p>
