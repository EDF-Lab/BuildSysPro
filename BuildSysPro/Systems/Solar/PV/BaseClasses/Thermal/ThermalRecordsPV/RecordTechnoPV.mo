...
record RecordTechnoPV
  ...
  parameter Modelica.Units.SI.Length epaisseur[n]
  ...
  parameter Modelica.Units.SI.Emissivity eps_fg "Front face emissivity in LWR";
  parameter Modelica.Units.SI.Emissivity eps_bg "Back face emissivity in LWR";
