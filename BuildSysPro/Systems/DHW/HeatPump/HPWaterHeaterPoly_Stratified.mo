...
model HPWaterHeaterPoly_Stratified
  ...
  parameter Modelica.Units.SI.Height tankHeight=1.3 "Tank height [m]"
    annotation (Dialog(group="Tank"));
...
equation
  ...
  connect(waterHeaterHeatPump.Pq_cond, stratifiedWaterTank.heatInput)
    annotation (Line(points={{-10.5,-13},{20,-13},{20,30},{36.2222,30}},
        color={0,0,127}));
  ...
  connect(stratifiedWaterTank.T_sensor, waterHeaterHeatPump.T_water)
    annotation (Line(points={{75.8889,28},{90,28},{90,80},{-66,80},{-66,-16},{
          -45,-16}},    color={0,0,127}));
