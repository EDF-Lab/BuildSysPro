...
SI.Temperature Tg2(start=Tsens.T) " Flue gas temperature ";
SI.Temperature Toutd " Outdoor temperature ";
SI.Temperature Tg0(start=Tsens.T)
    " Temperature of combustion gas before meeting m1 ";
SI.Temperature Tg1(start=Tsens.T)
    " Temperature of combustion gas before meeting m2 ";
SI.Temperature Tm1(start=Tsens.T)
    " Temperature of mass1 (connected to ambiant air) ";
SI.Temperature Tm2(start=Tsens.T)
    " Temperature of mass2 (connected to heat exchanger) ";
SI.Temperature Tlqi " Temperature of liquid entering heat exchanger ";
SI.Temperature Tlqo(start=Tsens.T)
    " Temperature of liquid out of heat exchanger ";

// MASSES
parameter SI.Mass mfg50=5 " Flue gas leak flow at (Texh-Toutdoor)=50 C ";
parameter SI.Mass mfgfanstp=65
    " Mass flow of flue gas during fan op after stp ";
parameter SI.Mass mflq=96 " Mass flow of liquid entering heat exchanger ";
SI.Mass mfa(start=0) " Combustion air mass flow ";
SI.Mass mff(start=0) " Fuel mass flow ";
SI.Mass mfg(start=0) " Flue gas leak flow ";
...
parameter SI.Power Pmax=7650 " Maximum power of the PGVH stove ";
...
//------------------------------------------------------------------------------------
public
  Modelica.Blocks.Interfaces.RealInput g "fraction of maximum power"
    annotation (Placement(transformation(extent={{-116,8},{-76,48}}),
        iconTransformation(extent={{-102,12},{-74,40}})));
public
  Modelica.Blocks.Interfaces.RealInput Ton
    "Min temperature before stove starts"
...
public
  Modelica.Blocks.Interfaces.RealInput Toff
    "Max temperature before stove stops"
    annotation (Placement(transformation(extent={{-20,-20},{20,20}},
        rotation=270,
        origin={30,102}),
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a Tsens
    ...
    annotation (Placement(transformation(extent={{-102,-60},{-76,-34}})));
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_b PowerOut
    ...
    annotation (Placement(transformation(extent={{64,-16},{92,12}})));
  Modelica.Blocks.Interfaces.BooleanInput presence
    "Indicates if the user is present in the house"
    annotation (Placement(transformation(extent={{-116,62},{-76,102}}),
...
when sample(t0+1/f,1/f) then
  ...
  connect(Ton, Ton_conv.T) annotation (Line(
      points={{-36,102},{-38,102},{-38,66},{-30,66}},
      color={0,0,127},
      smooth=Smooth.None));
