...
connector SolarFluxInput =
                      input Real
  "Informations de flux (GLO et CLO) données en entrée"
...
<p>Connector with one input signal of type Real</p>
...
Initial model : <a href=\"Modelica.Blocks.Interfaces.RealInput\">RealInput</a>, Martin Otter, Copyright © Modelica Association and DLR.<br>
--------------------------------------------------------------</b></p>
</html>"));
