...
extends Modelica.Icons.Example;
 package Medium = IBPSA.Media.Water "Medium model";
  ...
  IBPSA.Fluid.Interfaces.StaticTwoPortConservationEquation ste(
    redeclare package Medium = Medium,
    m_flow_nominal=0.01,
    show_T=true,
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/Interfaces/Examples/ConservationEquation.mos"
        "Simulate and plot"),
