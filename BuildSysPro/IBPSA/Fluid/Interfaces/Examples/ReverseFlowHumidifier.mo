...
package Medium = IBPSA.Media.Air;
  ...
  IBPSA.Fluid.Humidifiers.Humidifier_u humBac(
  ...
  IBPSA.Fluid.Humidifiers.Humidifier_u humFor(
    redeclare package Medium = Medium,
    dp_nominal=0,
    m_flow(start=1),
    m_flow_nominal=1,
  ...
  Modelica.Fluid.Sources.MassFlowSource_T source1(
    ...
    m_flow=0.5) "Fluid source"
        ...
        extent={{-10,-10},{10,10}},
        origin={-90,30})));
  IBPSA.Fluid.Sources.Boundary_pT sink1(redeclare package Medium = Medium,
  ...
  IBPSA.Fluid.Sensors.Temperature senTem1(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false) "Temperature sensor"
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/ReverseFlowHumidifier.mos"
        "Simulate and plot"),
...
with
<code>IBPSA.Fluid.Sources.FixedBoundary</code>
