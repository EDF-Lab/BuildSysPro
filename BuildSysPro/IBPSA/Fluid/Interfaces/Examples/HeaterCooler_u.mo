...
model HeaterCooler_u
 ...
 package Medium = IBPSA.Media.Water;
  ...
  IBPSA.Fluid.HeatExchangers.HeaterCooler_u hea1(
  ...
  IBPSA.Fluid.Sources.Boundary_pT sin_1(
    ...
    startTime=0) "Control signal"
            ...
            194}})));
  IBPSA.Fluid.HeatExchangers.HeaterCooler_u hea2(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Heater and cooler"
    annotation (Placement(transformation(extent={{28,134},{48,154}})));
  Modelica.Blocks.Math.Gain gain(k=-1) annotation (Placement(transformation(
          extent={{-50,174},{-30,194}})));
  IBPSA.Fluid.HeatExchangers.HeaterCooler_u hea3(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  IBPSA.Fluid.HeatExchangers.HeaterCooler_u hea4(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res_4(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=180)));
  IBPSA.Fluid.MixingVolumes.MixingVolume mix1(
    redeclare package Medium = Medium,
    V=0.000001,
    nPorts=2,
    m_flow_nominal=0.5,
  ...
  IBPSA.Fluid.HeatExchangers.HeaterCooler_u hea5(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  IBPSA.Fluid.HeatExchangers.HeaterCooler_u hea7(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res_8(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(
        origin={90,-260},
        extent={{-10,-10},{10,10}},
        rotation=180)));
  IBPSA.Fluid.MixingVolumes.MixingVolume mix2(
    redeclare package Medium = Medium,
    V=0.000001,
    nPorts=2,
    m_flow_nominal=0.5,
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTem4a(
    redeclare package Medium = Medium,
    m_flow_nominal=0.5,
    tau=0) "Temperature sensor"
    annotation (Placement(transformation(extent={{-12,22},{8,42}})));
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTem4b(
    redeclare package Medium = Medium,
    m_flow_nominal=0.5,
    tau=0) "Temperature sensor"
...
Moved model to <code>IBPSA.Fluid.Interfaces.Examples</code>.
</li>
<li>
