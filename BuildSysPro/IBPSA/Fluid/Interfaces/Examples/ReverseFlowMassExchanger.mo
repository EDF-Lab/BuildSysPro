...
package Medium = IBPSA.Media.Air;
  ...
  Modelica.Fluid.Sources.MassFlowSource_T source2(
    ...
    X={0.02,0.98})  annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        origin={38,70})));
  IBPSA.Fluid.MassExchangers.ConstantEffectiveness masExcFor(
  ...
  IBPSA.Fluid.MassExchangers.ConstantEffectiveness masExcRev(
    redeclare package Medium1 = Medium,
    redeclare package Medium2 = Medium,
    m1_flow_nominal=1,
    m2_flow_nominal=1,
  ...
  IBPSA.Fluid.Sources.Boundary_pT sink2(redeclare package Medium = Medium,
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/ReverseFlowMassExchanger.mos"
        "Simulate and plot"),
