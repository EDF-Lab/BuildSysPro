...
extends Modelica.Icons.Example;
 package MediumW = IBPSA.Media.Water "Medium model";
 package MediumA = IBPSA.Media.Air "Medium model";
...
protected
  model SubModel
    ...
    IBPSA.Fluid.Interfaces.StaticTwoPortConservationEquation conEqn(
      redeclare package Medium = Medium,
      m_flow_nominal=0.01,
      show_T=true,
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/Interfaces/Examples/StaticTwoPortConservationEquation.mos"
        "Simulate and plot"),
