...
model EightPortHeatMassExchanger
 ...
 Modelica.SIunits.HeatFlowRate Q1_flow = vol1.heatPort.Q_flow
  ...
  IBPSA.Fluid.MixingVolumes.MixingVolume vol3(
    ...
    energyDynamics=if tau3 > Modelica.Constants.eps then energyDynamics
         else Modelica.Fluid.Types.Dynamics.SteadyState,
  ...
  IBPSA.Fluid.MixingVolumes.MixingVolume vol4(
    ...
    nPorts=2,
    energyDynamics=if tau4 > Modelica.Constants.eps then energyDynamics
         else Modelica.Fluid.Types.Dynamics.SteadyState,
    massDynamics=if tau4 > Modelica.Constants.eps then massDynamics else
        Modelica.Fluid.Types.Dynamics.SteadyState,
