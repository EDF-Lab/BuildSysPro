...
model MixingVolume "Test model for mixing volumes"
  ...
  IBPSA.Fluid.Sources.Boundary_pT sou(
    ...
    T=293.15,
    use_p_in=true,
    nPorts=3) annotation (Placement(transformation(extent={{-70,48},{-50,68}})));
  IBPSA.Fluid.Sources.Boundary_pT sin(
    redeclare package Medium = Medium,
    nPorts=3,
    use_p_in=false,
    p=101325,
    T=283.15) annotation (Placement(transformation(extent={{130,48},{110,68}})));
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolume.mos"
        "Simulate and plot"),
