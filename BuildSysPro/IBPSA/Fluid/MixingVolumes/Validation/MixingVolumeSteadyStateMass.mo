...
model MixingVolumeSteadyStateMass "Test model for steady state mass dynamics"
  ...
  IBPSA.Fluid.MixingVolumes.MixingVolume vol(
    ...
    nPorts=2,
    mSenFac=2) "Mixing volume with steady state mass dynamics"
...
__Dymola_Commands(file=
          "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeSteadyStateMass.mos"
        "Simulate and plot"));
