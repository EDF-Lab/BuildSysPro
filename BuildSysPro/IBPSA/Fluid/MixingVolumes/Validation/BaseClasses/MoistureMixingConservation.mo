within BuildSysPro.IBPSA.Fluid.MixingVolumes.Validation.BaseClasses;
partial model MoistureMixingConservation
  ...
  IBPSA.Fluid.Sources.MassFlowSource_h sou1(
  ...
  IBPSA.Fluid.Sensors.MassFlowRate senMasFlo(redeclare package
      Medium =                                                          Medium,
