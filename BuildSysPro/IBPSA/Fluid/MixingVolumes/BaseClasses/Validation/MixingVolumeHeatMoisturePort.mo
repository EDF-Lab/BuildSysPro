within BuildSysPro.IBPSA.Fluid.MixingVolumes.BaseClasses.Validation;
model MixingVolumeHeatMoisturePort
  ...
  extends
    IBPSA.Fluid.MixingVolumes.BaseClasses.Validation.MixingVolumeHeatPortWater(
     redeclare package Medium = IBPSA.Media.Air, redeclare each
      IBPSA.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatMoisturePort
      vol);
...
__Dymola_Commands(file=
  "modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatMoisturePort.mos"
  "Simulate and plot"));
