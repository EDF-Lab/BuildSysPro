...
model ConstantEffectivenessZeroFlowBothStreams
  ...
  extends IBPSA.Fluid.MassExchangers.Examples.ConstantEffectiveness(
      PSin_1(height=0, offset=1E5), PIn(height=0, offset=101325));
...
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.MassExchangers.ConstantEffectiveness\">IBPSA.Fluid.MassExchangers.ConstantEffectiveness</a>
