within BuildSysPro.IBPSA.Fluid.Sensors.Conversions.Examples;
model To_VolumeFraction "Example problem for conversion model"
  ...
  IBPSA.Fluid.Sensors.TraceSubstances senCO2(redeclare package
      Medium =                                                          Medium,
  ...
  IBPSA.Fluid.Sensors.TraceSubstancesTwoPort senTraSubPeo(
    m_flow_nominal=0.1,
    redeclare package Medium = Medium,
    C_start=0,
  ...
  IBPSA.Fluid.Sensors.TraceSubstancesTwoPort senTraSubFre(
    m_flow_nominal=0.1,
    redeclare package Medium = Medium,
    C_start=0,
    initType=Modelica.Blocks.Types.Init.InitialState)
