...
model Density "Test model for the density sensor"
  ...
  IBPSA.Fluid.Sensors.Density senDenVol(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false) "Density sensor for the volume"
  ...
  IBPSA.Fluid.Sensors.DensityTwoPort senDenFlo(redeclare package
      Medium =
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Sensors/Examples/Density.mos"
        "Simulate and plot"),
