...
model TemperatureDryBulb "Test model for the dry bulb temperature sensor"
 ...
 package Medium = IBPSA.Media.Air "Medium model";
  IBPSA.Fluid.Sources.Boundary_pT amb(
    ...
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-2,-60})));
  IBPSA.Fluid.Sources.MassFlowSource_T masFloRat(
    redeclare package Medium = Medium,
    use_T_in=true,
    use_m_flow_in=true,
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort temSteSta(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort temDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort temDynLoss(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    initType=Modelica.Blocks.Types.Init.InitialState,
    transferHeat=true,
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/Sensors/Examples/TemperatureDryBulb.mos"
        "Simulate and plot"),
