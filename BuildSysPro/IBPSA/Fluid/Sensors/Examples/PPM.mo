...
model PPM "Test model for the extra property sensor outputting PPM"
  ...
  IBPSA.Fluid.Sensors.PPM senPPMVol(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false) "PPM sensor for mixing volume"
  ...
  IBPSA.Fluid.Sensors.PPMTwoPort senPPMTwoPort(
    redeclare package Medium = Medium,
    ...
    m_flow_nominal=m_flow_nominal) "PPM sensor" annotation (Placement(
        ...
        rotation=90,
        origin={80,10})));
  IBPSA.Fluid.Sensors.PPM senPPMIn(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false) "PPM sensor for inlet"
  ...
  IBPSA.Fluid.Sensors.PPMTwoPort senPPMRev(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}}, origin={50,
            -50})));
  IBPSA.Fluid.Sensors.PPMTwoPort senPPMSta(
    ...
    m_flow_nominal=m_flow_nominal) "Static PPM sensor" annotation (Placement(
        transformation(extent={{10,-10},{-10,10}}, origin={10,-50})));
  ...
  IBPSA.Fluid.Sensors.PPM senPPMVol2(redeclare package Medium = Medium,
      warnAboutOnePortConnection=false) "PPM sensor for mixing volume"
    annotation (Placement(transformation(extent={{120,80},{140,100}})));
  IBPSA.Fluid.Sources.MassFlowSource_T mSouSta(
    redeclare package Medium = Medium,
    nPorts=1,
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Sensors/Examples/PPM.mos"
        "Simulate and plot"),
