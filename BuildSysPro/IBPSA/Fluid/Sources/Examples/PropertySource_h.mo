...
model PropertySource_h "Model that illustrates the use of PropertySource_h"
  ...
  IBPSA.Fluid.Sources.PropertySource_h proSouH(redeclare package
      Medium =
        Medium, use_h_in=true)
    "Property source that prescribes the specific enthalpy"
    annotation (Placement(transformation(extent={{-10,30},{10,50}})));
  IBPSA.Fluid.Sources.PropertySource_h proSouC(redeclare package
      Medium =
  ...
  IBPSA.Fluid.Sources.MassFlowSource_h bouH(
    redeclare package Medium = Medium,
    nPorts=1,
    use_m_flow_in=true) "Boundary for specific enthalpy test"
