...
equation
  ...
  connect(weaDat.weaBus, nor.weaBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  annotation (__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Sources/Examples/Outside_CpData_Specification.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model validates the specification of the wind pressure profile
in the information section of the model
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.Sources.Outside_CpData\">IBPSA.Fluid.Sources.Outside_CpData</a>.
