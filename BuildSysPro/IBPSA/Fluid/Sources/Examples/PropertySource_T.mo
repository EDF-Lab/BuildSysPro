within BuildSysPro.IBPSA.Fluid.Sources.Examples;
model PropertySource_T "Model that illustrates the use of PropertySource_T"
  ...
  IBPSA.Fluid.Sources.PropertySource_T proSouXi(redeclare package
      Medium =
  ...
  IBPSA.Fluid.Sources.PropertySource_T proSouT(redeclare package
      Medium =
        Medium, use_T_in=true)
    "Property source that prescribes the temperature"
    annotation (Placement(transformation(extent={{-10,30},{10,50}})));
  IBPSA.Fluid.Sources.PropertySource_T proSouC(redeclare package
      Medium =
        Medium, use_C_in=true) "Property source that prescribes C"
...
the <a href=\"modelica://BuildSysPro.IBPSA.Fluid.Sources.PropertySource_T\">
