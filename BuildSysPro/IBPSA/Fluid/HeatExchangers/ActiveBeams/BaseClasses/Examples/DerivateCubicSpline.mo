within BuildSysPro.IBPSA.Fluid.HeatExchangers.ActiveBeams.BaseClasses.Examples;
...
equation
  ...
  annotation (experiment(Tolerance=1e-6, StopTime=1.0),__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/BaseClasses/Examples/DerivateCubicSpline.mos"
        "Simulate and plot"),
        Documentation(info="<html>
<p>
The example tests the implementation of
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.HeatExchangers.ActiveBeams.BaseClasses.DerivativesCubicSpline\">
