within BuildSysPro.IBPSA.Fluid.HeatExchangers.ActiveBeams.Validation;
model NumberOfBeams
  ...
  IBPSA.Fluid.Sources.FixedBoundary sin_3(redeclare package Medium = MediumA,
      nPorts=2)
  ...
  IBPSA.Fluid.Sources.MassFlowSource_T souAir10(
    redeclare package Medium = MediumA,
    use_m_flow_in=false,
    nPorts=1,
