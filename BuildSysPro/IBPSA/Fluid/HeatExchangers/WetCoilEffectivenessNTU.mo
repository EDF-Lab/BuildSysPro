...
model WetCoilEffectivenessNTU
  ...
  extends IBPSA.Fluid.Interfaces.PartialFourPortInterface(redeclare
      replaceable package Medium2 = IBPSA.Media.Air);
  ...
  import con = BuildSysPro.IBPSA.Fluid.Types.HeatExchangerConfiguration;
  import flo = BuildSysPro.IBPSA.Fluid.Types.HeatExchangerFlowRegime;
  ...
  parameter IBPSA.Fluid.Types.HeatExchangerConfiguration configuration=con.CounterFlow
  ...
  Modelica.Units.SI.HeatFlowRate QLat2_flow=IBPSA.Utilities.Psychrometrics.Constants.h_fg
...
protected
  ...
  Real delta1=1E-1
    "Parameter for normalization";
  Real fac1 = IBPSA.Utilities.Math.Functions.smoothMin(
    (1/delta * m1_flow/m1_flow_nominal)^2,1,delta1);
  Real fac2 = IBPSA.Utilities.Math.Functions.smoothMin(
    (1/delta * m2_flow/m2_flow_nominal)^2,1,delta1);
  Real Qfac = fac1*fac2;

  IBPSA.Fluid.HeatExchangers.BaseClasses.WetCoilUARated UAFroRated(
    ...
    final mWat_flow=m1_flow_nominal) "Model that computes UA_nominal";

  IBPSA.Fluid.HeatExchangers.HeaterCooler_u heaCoo(
    redeclare final package Medium = Medium1,
    final dp_nominal=dp1_nominal,
    final m_flow_nominal=m1_flow_nominal,
    final energyDynamics=energyDynamics,
    final Q_flow_nominal=-1,
    u(final unit="W")) "Heat exchange with water stream"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));

  IBPSA.Fluid.Humidifiers.Humidifier_u heaCooHum_u(
    redeclare final package Medium = Medium2,
    final mWat_flow_nominal=1,
    final dp_nominal=dp2_nominal,
    final m_flow_nominal=m2_flow_nominal,
    final energyDynamics=energyDynamics,
    u(final unit="kg/s")) "Heat and moisture exchange with air stream"
  ...
  IBPSA.Fluid.HeatExchangers.BaseClasses.WetCoilDryWetRegime dryWetCalcs(
    ...
    final Qfac=Qfac) "Dry/wet calculations block"
  ...
  Modelica.Blocks.Sources.RealExpression m_flow_a1Exp(
    final y=IBPSA.Utilities.Math.Functions.regNonZeroPower(
...
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.HeatExchangers.DryCoilEffectivenessNTU\">
...
see
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.HeatExchangers.BaseClasses.WetCoilWetRegime\">
IBPSA.Fluid.HeatExchangers.BaseClasses.WetCoilWetRegime</a>.
and
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.HeatExchangers.BaseClasses.WetCoilDryWetRegime\">
IBPSA.Fluid.HeatExchangers.BaseClasses.WetCoilDryWetRegime</a>.
</p>
...
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.HeatExchangers.Validation.WetCoilEffectivenessNTU\">
IBPSA.Fluid.HeatExchangers.Validation.WetCoilEffectivenessNTU</a>.
<h4>References</h4>
