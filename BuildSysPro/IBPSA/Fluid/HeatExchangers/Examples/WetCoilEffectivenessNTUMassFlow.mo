within BuildSysPro.IBPSA.Fluid.HeatExchangers.Examples;
model WetCoilEffectivenessNTUMassFlow
  ...
  extends
    IBPSA.Fluid.HeatExchangers.Examples.BaseClasses.EffectivenessNTUMassFlow(
    sou_1(nPorts=1),
    sin_1(nPorts=1),
    sou_2(nPorts=1),
    sin_2(nPorts=1));

  IBPSA.Fluid.HeatExchangers.WetCoilEffectivenessNTU hex(
    ...
    UA_nominal=Q_flow_nominal/IBPSA.Fluid.HeatExchangers.BaseClasses.lmtd(
        T_a1_nominal,
        T_b1_nominal,
        T_a2_nominal,
        T_b2_nominal),
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
    file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/WetCoilEffectivenessNTUMassFlow.mos"
      "Simulate and plot"),
...
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.HeatExchangers.Examples.DryCoilEffectivenessNTUMassFlow\">
IBPSA.Fluid.HeatExchangers.Examples.DryCoilEffectivenessNTUMassFlow</a>
