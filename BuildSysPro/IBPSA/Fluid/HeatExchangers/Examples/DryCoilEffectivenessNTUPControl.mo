...
model DryCoilEffectivenessNTUPControl
 ...
 package Medium1 = IBPSA.Media.Water "Medium model for water";
 package Medium2 = IBPSA.Media.Air "Medium model for air";
  ...
  IBPSA.Fluid.Sources.Boundary_pT sou_1(
    ...
    nPorts=1,
    use_T_in=false,
    T=T_a1_nominal) "Boundary condition"
    annotation (Placement(transformation(extent={{-50,50},{-30,70}})));
  IBPSA.Fluid.Sensors.TemperatureTwoPort temSen(redeclare package Medium =
        Medium2, m_flow_nominal=m2_flow_nominal) "Temperature sensor"
  ...
  IBPSA.Fluid.HeatExchangers.DryCoilEffectivenessNTU hex(
    ...
    dp2_nominal(displayUnit="Pa") = 200 + 100) "Heat exchanger"
...
__Dymola_Commands(file=
          "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/DryCoilEffectivenessNTUPControl.mos"
        "Simulate and plot"),
