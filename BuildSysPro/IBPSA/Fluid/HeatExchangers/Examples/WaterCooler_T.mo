...
model WaterCooler_T
  ...
  extends IBPSA.Fluid.HeatExchangers.Examples.BaseClasses.Heater(
...
First implementation.
    ...
    __Dymola_Commands(file= "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/WaterCooler_T.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-8),
