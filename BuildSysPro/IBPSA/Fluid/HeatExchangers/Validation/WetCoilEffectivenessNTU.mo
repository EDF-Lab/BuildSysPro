within BuildSysPro.IBPSA.Fluid.HeatExchangers.Validation;
model WetCoilEffectivenessNTU
  "Model that validates the wet coil effectiveness-NTU model"
  extends Modelica.Icons.Example;

  package Medium_W = IBPSA.Media.Water;
  package Medium_A = IBPSA.Media.Air;
  ...
  IBPSA.Fluid.Sources.Boundary_pT sinWat(redeclare package Medium = Medium_W,
      nPorts=2) "Sink for water"
    annotation (Placement(transformation(extent={{50,50},{30,70}})));
  IBPSA.Utilities.Psychrometrics.ToTotalAir conversion
  ...
  IBPSA.Utilities.Psychrometrics.TWetBul_TDryBulXi wetBulIn(redeclare package
              Medium =
               Medium_A) "Computation of wet bulb temperature"
  ...
  IBPSA.Utilities.Psychrometrics.TWetBul_TDryBulXi wetBulOut(redeclare package
              Medium =
               Medium_A) "Computation of wet bulb temperature"
  ...
  IBPSA.Fluid.HeatExchangers.WetCoilEffectivenessNTU hexWetNTU(
  ...
  Sensors.RelativeHumidityTwoPort relHumOut_eps(redeclare package
      Medium =
        Medium_A, m_flow_nominal=m2_flow_nominal) "Outlet relative humidity"
    annotation (Placement(transformation(extent={{-80,30},{-100,50}})));
  IBPSA.Fluid.HeatExchangers.WetCoilEffectivenessNTU hexWetNTU_TX(
    redeclare package Medium1 = Medium_W,
    redeclare package Medium2 = Medium_A,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true,
    ...
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
    file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/WetCoilEffectivenessNTU.mos"
  "Simulate and plot"),
...
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.HeatExchangers.WetCoilEffectivenessNTU\">
IBPSA.Fluid.HeatExchangers.WetCoilEffectivenessNTU</a>
model.
</p>
<h4>Validation</h4>
<p>
