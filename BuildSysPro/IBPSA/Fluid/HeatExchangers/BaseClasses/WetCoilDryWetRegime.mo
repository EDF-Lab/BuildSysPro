...
model WetCoilDryWetRegime
  ...
  input IBPSA.Fluid.Types.HeatExchangerFlowRegime cfg=IBPSA.Fluid.Types.HeatExchangerFlowRegime.CounterFlow
  ...
  Modelica.Blocks.Interfaces.RealOutput mCon_flow(
    ...
    annotation (
      Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=0,
        origin={150,-100})));
  IBPSA.Fluid.HeatExchangers.BaseClasses.WetCoilDryRegime fullyDry(
    final UAWat=UAWat,
  ...
  IBPSA.Fluid.HeatExchangers.BaseClasses.WetCoilWetRegime fullyWet(
    final UAWat=UAWat,
    final mWat_flow=mWat_flow,
    final cpWat=cpWat,
    final TWatIn=TWatIn,
...
protected
  ...
  IBPSA.Utilities.Psychrometrics.pW_X pWIn(final X_w=X_wAirIn, final p_in=pAir);
  IBPSA.Utilities.Psychrometrics.TDewPoi_pW TDewIn(final p_w=pWIn.p_w);
...
equation
  ...
  mu_FW = IBPSA.Utilities.Math.Functions.spliceFunction(
    pos=0,
    neg=1,
    x=fullyWet.TSurAirIn - TAirInDewPoi,
    deltax=IBPSA.Utilities.Math.Functions.smoothMax(
      abs(fullyDry.TSurAirOut - fullyWet.TSurAirIn),
      1e-2,
      1e-3));
  ...
  mu_FD = IBPSA.Utilities.Math.Functions.spliceFunction(
    pos=1,
    neg=0,
    x=fullyDry.TSurAirOut - TAirInDewPoi,
    deltax=IBPSA.Utilities.Math.Functions.smoothMax(
      abs(fullyDry.TSurAirOut - fullyWet.TSurAirIn),
      1e-2,
      1e-3));
  ...
  mCon_flow = QLat_flow/IBPSA.Utilities.Psychrometrics.Constants.h_fg*Qfac;
