...
function motorEfficiencyCurve
  ...
  output
    IBPSA.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters_yMot motorEfficiency_yMot(y={0,0.1,
        0.2,0.3,0.4,0.6,0.8,1,1.2}, eta=zeros(nPoi))
    "Motor efficiency vs. motor part load ratio";
...
algorithm
  if P_nominal>1E-6 then
    for j in 1:nPoi loop
      motorEfficiency_yMot.eta[j] := eta_max*
        IBPSA.Utilities.Math.Functions.smoothInterpolation(
        x=P_nominal,
        xSup=u2,
        ySup=tab[j, :],
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildSysPro/IBPSA/Resources/Images/Fluid/Movers/BaseClasses/Characteristics/MotorEfficiencyCurves.png\"
width=\"500\"/>
</p>
<h4>References</h4>
<p>
