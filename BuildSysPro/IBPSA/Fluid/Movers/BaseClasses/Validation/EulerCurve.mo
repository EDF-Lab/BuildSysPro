...
equation
  der(x)=1;
  etaApp = IBPSA.Fluid.Movers.BaseClasses.Euler.correlation(x);
  etaOri = correlation(x);

  annotation (experiment(Tolerance=1e-6, StopTime=10.0),
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/EulerCurve.mos"
 "Simulate and plot"),
 Documentation(
info="<html>
<p>
...
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Euler.correlation\">
