...
model MotorEfficiencyMethods
  ...
  IBPSA.Fluid.Movers.Data.Generic per(final pressure(V_flow={0,1}, dp={1000,0}),
      final etaHydMet=IBPSA.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided)
    "Performance record";
  parameter Modelica.Units.SI.Density rhoFlu=1.2 "Fluid density";

  IBPSA.Fluid.Movers.BaseClasses.FlowMachineInterface eff1(
    per(
  ...
  IBPSA.Fluid.Movers.BaseClasses.FlowMachineInterface eff2(
    per(
      pressure=per.pressure,
      etaHydMet=per.etaHydMet,
  ...
  IBPSA.Fluid.Movers.BaseClasses.FlowMachineInterface eff3(
    per(
      pressure=per.pressure,
      etaHydMet=per.etaHydMet,
      etaMotMet=IBPSA.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.Efficiency_MotorPartLoadRatio,
  ...
  IBPSA.Fluid.Movers.BaseClasses.FlowMachineInterface eff4(
    per(
      pressure=per.pressure,
      etaHydMet=per.etaHydMet,
...
IBPSA.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod</a>.
...
<a href=\"Modelica://IBPSA.Fluid.Movers.BaseClasses.Characteristics.motorEfficiencyCurve\">
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/MotorEfficiencyMethods.mos"
        "Simulate and plot"));
