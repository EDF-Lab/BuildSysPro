...
algorithm
  ...
  y := if y1 > 0.002 then y1 else IBPSA.Utilities.Math.Functions.smoothMax(
    x1=y1,
    x2=0.001,
    deltaX=0.0005);
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildSysPro/IBPSA/Resources/Images/Fluid/Movers/BaseClasses/Euler/eulerCorrelation.svg\"/>
</p>
<p>
...
(plotted by 
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Validation.EulerCurve\">
IBPSA.Fluid.Movers.BaseClasses.Validation.EulerCurve</a>).
</p>
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildSysPro/IBPSA/Resources/Images/Fluid/Movers/BaseClasses/Euler/EulerCurve.png\"/>
</p>
<p>
...
using
<a href=\"modelica://BuildSysPro/IBPSA/Resources/Images/Fluid/Movers/BaseClasses/Euler/eulerCorrelation.txt\">
this script</a>.
</p>
</html>",
revisions="<html>
