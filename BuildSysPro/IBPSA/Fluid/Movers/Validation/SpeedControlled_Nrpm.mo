...
model SpeedControlled_Nrpm "Fan with zero mass flow rate and speed as input"
 ...
 extends
    IBPSA.Fluid.Movers.Validation.BaseClasses.FlowMachine_ZeroFlow(
    gain(k=1500),
    redeclare IBPSA.Fluid.Movers.SpeedControlled_Nrpm floMacSta(
      redeclare package Medium = Medium,
      per(pressure(V_flow={0,m_flow_nominal,2*m_flow_nominal}/1.2, dp={2*
              dp_nominal,dp_nominal,0})),
      use_inputFilter=false,
      energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
    redeclare IBPSA.Fluid.Movers.SpeedControlled_Nrpm floMacDyn(
      redeclare package Medium = Medium,
      per(pressure(V_flow={0,m_flow_nominal,2*m_flow_nominal}/1.2, dp={2*
              dp_nominal,dp_nominal,0})),
      use_inputFilter=false,
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Movers/Validation/SpeedControlled_Nrpm.mos"
        "Simulate and plot"),
