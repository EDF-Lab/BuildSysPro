...
model PumpCurveDerivatives
  ...
  IBPSA.Utilities.Diagnostics.AssertInequality assIne(threShold=1e-8)
  ...
  IBPSA.Utilities.Diagnostics.AssertInequality assIne1(threShold=1e-8)
    "Assertion check for positive derivatives"
    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
  IBPSA.Utilities.Diagnostics.AssertInequality assIne2(threShold=1e-8)
    "Assertion check for positive derivatives"
