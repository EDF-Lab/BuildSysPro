within BuildSysPro.IBPSA.Fluid.Movers.Validation.BaseClasses;
model ControlledFlowMachine
  ...
  IBPSA.Fluid.Sensors.RelativePressure relPre(redeclare package
    ...
    annotation (Placement(transformation(extent={{10,-10},{-10,10}}, origin={-10,
            32})));
  replaceable IBPSA.Fluid.Movers.SpeedControlled_y fan1(
    redeclare package Medium = Medium,
  ...
  replaceable IBPSA.Fluid.Movers.FlowControlled_dp fan3(
    redeclare package Medium = Medium,
    m_flow_nominal=6000/3600*1.2,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare IBPSA.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
    constrainedby IBPSA.Fluid.Movers.FlowControlled_dp "Fan with head as input"
    annotation (Placement(transformation(extent={{-20,-70},{0,-50}})));
  replaceable IBPSA.Fluid.Movers.FlowControlled_m_flow fan2(
    redeclare package Medium = Medium,
    m_flow_nominal=6000/3600*1.2,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare IBPSA.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
  ...
  replaceable IBPSA.Fluid.Movers.SpeedControlled_Nrpm fan4(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare IBPSA.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
