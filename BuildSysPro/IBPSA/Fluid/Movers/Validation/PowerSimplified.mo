...
model PowerSimplified
  ...
  parameter IBPSA.Fluid.Movers.Data.Pumps.Wilo.Stratos30slash1to8 per
  ...
  IBPSA.Fluid.Movers.FlowControlled_dp pump_dp(
    redeclare package Medium = Medium,
    redeclare IBPSA.Fluid.Movers.Data.Pumps.Wilo.Stratos30slash1to8 per(
...
equation
  ...
  annotation (    experiment(Tolerance=1e-6, StopTime=200),
    __Dymola_Commands(file=
          "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Movers/Validation/PowerSimplified.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildSysPro/IBPSA/Resources/Images/Fluid/Movers/Validation/PowerSimplified.png\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
...
<code>expected subtype of record IBPSA.Fluid.Movers.Data.Generic</code>.
</li>
<li>
