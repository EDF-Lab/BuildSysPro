within BuildSysPro.IBPSA.Fluid.Movers;
model FlowControlled_m_flow
  "Fan or pump with ideally controlled mass flow rate as input signal"
  extends BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.PartialFlowMachine(
    final preVar=BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.PrescribedVariable.FlowRate,
    ...
    eff(
      per(
        final pressure = if per.havePressureCurve then
          ...
          BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Characteristics.flowParameters(
            V_flow = {i/(nOri-1)*2.0*m_flow_nominal/rho_default for i in 0:(nOri-1)},
            dp =     {i/(nOri-1)*2.0*dp_nominal for i in (nOri-1):-1:0}),
        final etaHydMet=
          if (per.etaHydMet ==
               BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.Power_VolumeFlowRate
            or per.etaHydMet ==
               BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.EulerNumber)
            and not per.havePressureCurve then
              BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided
          else per.etaHydMet,
        final etaMotMet=
          if (per.etaMotMet ==
               BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.Efficiency_MotorPartLoadRatio
            or per.etaMotMet ==
               BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.GenericCurve)
            and (not per.haveWMot_nominal and not per.havePressureCurve) then
               BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.NotProvided
          else per.etaMotMet),
  ...
  parameter Modelica.Units.SI.MassFlowRate constantMassFlowRate=m_flow_nominal
    "Constant pump mass flow rate, used when inputType=Constant" annotation (
      Dialog(enable=inputType == BuildSysPro.IBPSA.Fluid.Types.InputType.Constant));
  ...
  parameter Modelica.Units.SI.MassFlowRate[:] massFlowRates=m_flow_nominal*{per.speeds[
    ...
    annotation (Dialog(enable=inputType == BuildSysPro.IBPSA.Fluid.Types.InputType.Stages));
  ...
  Modelica.Blocks.Interfaces.RealInput m_flow_in(
    ...
    if inputType == BuildSysPro.IBPSA.Fluid.Types.InputType.Continuous
  ...
  annotation (
      Icon(graphics={
        Text(
          ...
          textColor={0,0,127},
          visible=inputType == BuildSysPro.IBPSA.Fluid.Types.InputType.Continuous or inputType == BuildSysPro.IBPSA.Fluid.Types.InputType.Stages,
          textString=DynamicSelect("m_flow", if inputType == BuildSysPro.IBPSA.Fluid.Types.InputType.Continuous then String(m_flow_in, leftJustified=false, significantDigits=3) else String(stage)))}),
...
This is for
<a href=\"https://github.com/BuildSysPro.IBPSA/modelica-BuildSysPro.IBPSA/issues/1705\">#1705</a>.
</li>
<li>
...
BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod</a>
and
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod\">
BuildSysPro.IBPSA.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod</a>.<br/>
This is for
...
This is for
<a href=\"https://github.com/BuildSysPro.IBPSA/modelica-BuildSysPro.IBPSA/issues/1659\">#1659</a>.
</li>
<li>
March 7, 2022, by Michael Wetter:<br/>
Set <code>final massDynamics=energyDynamics</code>.<br/>
This is for
<a href=\"https://github.com/BuildSysPro.IBPSA/modelica-BuildSysPro.IBPSA/issues/1542\">#1542</a>.
</li>
<li>
...
This is for
<a href=\"https://github.com/BuildSysPro.IBPSA/modelica-BuildSysPro.IBPSA/issues/1498\">#1498</a>.
</li>
<li>
February 21, 2020, by Michael Wetter:<br/>
Changed icon to display its operating stage.<br/>
This is for
<a href=\"https://github.com/BuildSysPro.IBPSA/modelica-BuildSysPro.IBPSA/issues/1294\">#1294</a>.
</li>
<li>
March 24, 2017, by Michael Wetter:<br/>
Renamed <code>filteredSpeed</code> to <code>use_inputFilter</code>.<br/>
This is for
<a href=\"https://github.com/BuildSysPro.IBPSA/modelica-BuildSysPro.IBPSA/issues/665\">#665</a>.
</li>
<li>
November 10, 2016, by Michael Wetter:<br/>
Changed default values for <code>massFlowRates</code>.<br/>
This is for
<a href=\"https://github.com/BuildSysPro.IBPSA/modelica-BuildSysPro.IBPSA/issues/583\">#583</a>.
</li>
<li>
March 2, 2016, by Filip Jorissen:<br/>
Refactored model such that it directly extends <code>PartialFlowMachine</code>.
This is for
<a href=\"https://github.com/BuildSysPro.IBPSA/modelica-BuildSysPro.IBPSA/issues/417\">#417</a>.
</li>
<li>
