within BuildSysPro.IBPSA.Fluid.HeatPumps.Calibration;
model ScrollWaterToWater
  "Calibration model for scroll water to water heat pump"
  extends Modelica.Icons.Example;
  extends
    IBPSA.Fluid.HeatPumps.Calibration.BaseClasses.PartialWaterToWater(
    ...
    calDat(tableName="ManufacturerData", fileName=
          ...
          "modelica://BuildSysPro/IBPSA/Resources/src/fluid/heatpumps/calibration/manufacturerData.txt")),
    UACon=12000.0,
    UAEva=12000.0,
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,-100},
    ...
    preferredView="info",
    __Dymola_Commands(file= "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/HeatPumps/Calibration/ScrollWaterToWater.mos"
        "Simulate and plot"),
