...
model ScrollWaterToWater
  ...
  extends IBPSA.Fluid.HeatPumps.Calibration.BaseClasses.PartialWaterToWater(
    ...
    calDat(tableName="ManufacturerData", fileName=
          Modelica.Utilities.Files.loadResource("modelica://BuildSysPro/Resources/IBPSA/src/fluid/heatpumps/calibration/manufacturerData.txt")),
    UACon=12000.0,
    UAEva=12000.0,
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,-100},
    ...
    preferredView="info",
    __Dymola_Commands(file= "modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/HeatPumps/Calibration/ScrollWaterToWater.mos"
        "Simulate and plot"),
