within BuildSysPro.IBPSA.Fluid.HeatPumps.Calibration.BaseClasses;
model PartialWaterToWater
  ...
  IBPSA.Fluid.Sources.Boundary_pT sin2(redeclare final package
      Medium =                                                          Medium2,
  ...
  IBPSA.Fluid.Sources.Boundary_pT sin1(redeclare final package
      Medium =                                                          Medium1,
  ...
  replaceable IBPSA.Fluid.HeatPumps.BaseClasses.PartialWaterToWater heaPum
    constrainedby
    IBPSA.Fluid.HeatPumps.BaseClasses.PartialWaterToWater(
