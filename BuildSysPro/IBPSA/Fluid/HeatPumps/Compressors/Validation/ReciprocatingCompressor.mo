within BuildSysPro.IBPSA.Fluid.HeatPumps.Compressors.Validation;
model ReciprocatingCompressor
  extends Modelica.Icons.Example;
  IBPSA.Fluid.HeatPumps.Compressors.ReciprocatingCompressor com(
...
equation
  ...
  annotation (__Dymola_Commands(file= "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/HeatPumps/Compressors/Validation/ReciprocatingCompressor.mos"
        "Simulate and plot"),
    experiment(
