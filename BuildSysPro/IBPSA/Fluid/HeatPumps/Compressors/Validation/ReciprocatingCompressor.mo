...
equation
  ...
  annotation (__Dymola_Commands(file= "modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/HeatPumps/Compressors/Validation/ReciprocatingCompressor.mos"
        "Simulate and plot"),
    experiment(
