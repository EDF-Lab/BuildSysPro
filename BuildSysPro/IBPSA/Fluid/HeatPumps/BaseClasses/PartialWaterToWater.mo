within BuildSysPro.IBPSA.Fluid.HeatPumps.BaseClasses;
partial model PartialWaterToWater
  ...
  extends IBPSA.Fluid.Interfaces.FourPortFlowResistanceParameters(
      final computeFlowResistance1=dp1_nominal > 0, final
      computeFlowResistance2=dp2_nominal > 0);
  ...
  replaceable
    IBPSA.Fluid.HeatPumps.Compressors.BaseClasses.PartialCompressor com
...
<a href = \"modelica://BuildSysPro.IBPSA.Fluid.HeatPumps.Compressors\">
