...
model ReciprocatingWaterToWater_ScalingFactor
  ...
  IBPSA.Fluid.HeatPumps.ReciprocatingWaterToWater heaPum1(
    redeclare package Medium1 = Medium1,
    redeclare package Medium2 = Medium2,
    dp1_nominal=1000,
    dp2_nominal=1000,
...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/HeatPumps/Validation/ReciprocatingWaterToWater_ScalingFactor.mos"
        "Simulate and plot"),
    experiment(
...
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.HeatPumps.ReciprocatingWaterToWater\">
