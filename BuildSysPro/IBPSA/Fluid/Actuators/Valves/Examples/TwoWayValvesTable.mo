...
model TwoWayValvesTable "Two way valve with linear opening characteristics"
  ...
  Valves.TwoWayTable valTab(
    ...
    flowCharacteristics=IBPSA.Fluid.Actuators.Valves.Data.Linear(),
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/Actuators/Valves/Examples/TwoWayValvesTable.mos"
        "Simulate and plot"),
