within BuildSysPro.IBPSA.Fluid.Actuators.Valves.Examples;
model ThreeWayValves "Three way valves with different opening characteristics"
  ...
  IBPSA.Fluid.Actuators.Valves.ThreeWayLinear valLin(
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/ThreeWayValves.mos"
        "Simulate and plot"),
...
Added <a href=\"modelica://BuildSysPro.IBPSA.Fluid.Actuators.Valves.ThreeWayTable\">IBPSA.Fluid.Actuators.Valves.ThreeWayTable</a>
to example.
</li>
<li>
