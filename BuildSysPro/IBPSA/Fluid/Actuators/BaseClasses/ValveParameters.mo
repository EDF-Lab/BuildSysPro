...
partial model ValveParameters "Model with parameters for valves"
  ...
  parameter IBPSA.Fluid.Types.CvTypes CvData=IBPSA.Fluid.Types.CvTypes.OpPoint
    "Selection of flow coefficient"
    annotation (Dialog(group="Flow Coefficient"));
  parameter Real Kv(
    fixed= if CvData==IBPSA.Fluid.Types.CvTypes.Kv then true else false)
    "Kv (metric) flow coefficient [m3/h/(bar)^(1/2)]"
  annotation(Dialog(group = "Flow Coefficient",
                    enable=(CvData == IBPSA.Fluid.Types.CvTypes.Kv)));
  parameter Real Cv(
    fixed= if CvData==IBPSA.Fluid.Types.CvTypes.Cv then true else false)
    "Cv (US) flow coefficient [USG/min/(psi)^(1/2)]"
  annotation(Dialog(group = "Flow Coefficient",
                    enable=(CvData == IBPSA.Fluid.Types.CvTypes.Cv)));
  parameter Modelica.Units.SI.Area Av(fixed=if CvData ==IBPSA.Fluid.Types.CvTypes.Av
         then true else false) "Av (metric) flow coefficient" annotation (
      Dialog(group="Flow Coefficient", enable=(CvData == IBPSA.Fluid.Types.CvTypes.Av)));
  ...
  parameter Modelica.Units.SI.PressureDifference dpValve_nominal(
    ...
    annotation (Dialog(group="Nominal condition", enable=(CvData == IBPSA.Fluid.Types.CvTypes.OpPoint)));
...
initial equation
  if CvData == IBPSA.Fluid.Types.CvTypes.OpPoint then
...
<ul>
<li><code>CvData = IBPSA.Fluid.Types.CvTypes.Av</code>: the flow coefficient is given by the metric <code>Av</code> coefficient (m^2).</li>
<li><code>CvData = IBPSA.Fluid.Types.CvTypes.Kv</code>: the flow coefficient is given by the metric <code>Kv</code> coefficient (m^3/h).</li>
<li><code>CvData = IBPSA.Fluid.Types.CvTypes.Cv</code>: the flow coefficient is given by the US <code>Cv</code> coefficient (USG/min).</li>
<li><code>CvData = IBPSA.Fluid.Types.CvTypes.OpPoint</code>: the flow is computed from the nominal operating point specified by <code>dp_nominal</code> and <code>m_flow_nominal</code>.</li>
</ul>
<p>
