...
model ThermalZones
  ...
  extends IBPSA.Fluid.FMI.ExportContainers.ThermalZones(
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/ThermalZones.mos"
        "Export FMU"));
end ThermalZones;
