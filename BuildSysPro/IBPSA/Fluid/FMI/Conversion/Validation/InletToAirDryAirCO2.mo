...
model InletToAirDryAirCO2
  ...
  extends IBPSA.Fluid.FMI.Conversion.Validation.InletToAirMoistAirCO2(
     redeclare replaceable package Medium =
        Modelica.Media.Air.SimpleAir (extraPropertiesNames={"CO2"}));
  annotation (Documentation(info="<html>
<p>
This validation test is identical to
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.FMI.Conversion.Validation.InletToAirMoistAirCO2\">
IBPSA.Fluid.FMI.Conversion.Validation.InletToAirMoistAirCO2</a>
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirDryAirCO2.mos"
        "Simulate and plot"),
