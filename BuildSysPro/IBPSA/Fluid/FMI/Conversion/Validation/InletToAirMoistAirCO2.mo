...
model InletToAirMoistAirCO2
  ...
  extends IBPSA.Fluid.FMI.Conversion.Validation.InletToAirDryAir(redeclare
      replaceable package Medium = IBPSA.Media.Air (extraPropertiesNames={"CO2"}));
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirMoistAirCO2.mos"
        "Simulate and plot"),
