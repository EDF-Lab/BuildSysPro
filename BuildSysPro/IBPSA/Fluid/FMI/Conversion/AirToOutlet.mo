within BuildSysPro.IBPSA.Fluid.FMI.Conversion;
block AirToOutlet
  "Conversion from real signals for a fluid to a IBPSA.Fluid.FMI.Interfaces.Outlet connector"
  ...
  IBPSA.Fluid.FMI.Interfaces.Outlet outlet(
