...
model CheckValve "Example model for check valve"
  ...
  IBPSA.Fluid.FixedResistances.CheckValve checkValve(
    ...
    m_flow_nominal=2,
    dpValve_nominal=3600) "Check valve"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  IBPSA.Fluid.FixedResistances.CheckValve checkValveDpFix(
    redeclare package Medium = Media.Water,
    m_flow_nominal=2,
    dpValve_nominal=3600,
    dpFixed_nominal=1e4) "Check valve with series resistance"
    annotation (Placement(transformation(extent={{-10,20},{10,40}})));
  IBPSA.Fluid.FixedResistances.CheckValve checkValve_m_flow(
    redeclare package Medium = Media.Water,
    m_flow_nominal=2,
    dpValve_nominal=3600) "Check valve where the flow rate is prescribed"
...
equation
  ...
  annotation (experiment(Tolerance=1e-06, StopTime=1),
      __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/CheckValve.mos"
        "Simulate and plot"),
