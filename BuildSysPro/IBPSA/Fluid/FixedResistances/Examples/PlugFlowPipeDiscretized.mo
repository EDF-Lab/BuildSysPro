within BuildSysPro.IBPSA.Fluid.FixedResistances.Examples;
model PlugFlowPipeDiscretized "Simple example of discretized plug flow pipe"
  ...
  IBPSA.Fluid.FixedResistances.PlugFlowPipeDiscretized pip(
    redeclare package Medium = Medium,
    nSeg=nSeg,
    dh=0.1,
    totLen=100,
...
equation
  ...
  annotation (
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/PlugFlowPipeDiscretized.mos"
        "Simulate and Plot"),
    experiment(StopTime=1000, Tolerance=1e-006),
    Documentation(info="<html>
<p>Basic test of model
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.FixedResistances.PlugFlowPipeDiscretized\">
IBPSA.Fluid.FixedResistances.PlugFlowPipeDiscretized</a>.
