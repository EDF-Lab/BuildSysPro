...
model FlowReversal
  ...
  package Medium = IBPSA.Media.Water "Medium in the pipe";
...
equation
  ...
  annotation (
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/FlowReversal.mos"
        "Simulate and Plot"),
