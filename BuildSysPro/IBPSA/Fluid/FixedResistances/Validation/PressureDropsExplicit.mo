within BuildSysPro.IBPSA.Fluid.FixedResistances.Validation;
model PressureDropsExplicit "Test of multiple resistances in series"
 ...
 package Medium = IBPSA.Media.Air "Medium model";
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res11(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res12(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) "Flow resistance"
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res22(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res21(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) "Flow resistance"
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res31(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) "Flow resistance"
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res32(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) "Flow resistance"
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res42(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) "Flow resistance"
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop res41(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) "Flow resistance"
  ...
  IBPSA.Fluid.Sources.MassFlowSource_h bou(
    redeclare package Medium = Medium,
    m_flow=1,
  ...
  IBPSA.Fluid.Sources.Boundary_ph sou1(
    redeclare package Medium = Medium,
    nPorts=1,
    p(displayUnit="Pa") = 101335,
    use_p_in=true) "Pressure boundary condition"
  ...
  IBPSA.Fluid.Sensors.MassFlowRate senMasFlo1(redeclare package
      Medium =                                                           Medium)
    "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,90},{80,110}})));

  IBPSA.Fluid.Sensors.MassFlowRate senMasFlo2(redeclare package
      Medium =                                                           Medium)
    "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));

  IBPSA.Fluid.Sensors.MassFlowRate senMasFlo3(redeclare package
      Medium =                                                           Medium)
    "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,-20},{80,0}})));

  IBPSA.Fluid.Sensors.MassFlowRate senMasFlo4(redeclare package
      Medium =                                                           Medium)
    "Mass flow rate sensor"
