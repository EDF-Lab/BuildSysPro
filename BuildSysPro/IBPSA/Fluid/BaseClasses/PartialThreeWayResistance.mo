within BuildSysPro.IBPSA.Fluid.BaseClasses;
partial model PartialThreeWayResistance
  ...
  replaceable IBPSA.Fluid.Interfaces.PartialTwoPortInterface res1
    constrainedby IBPSA.Fluid.Interfaces.PartialTwoPortInterface(redeclare
      final package Medium = Medium, allowFlowReversal=portFlowDirection_1 ==
        Modelica.Fluid.Types.PortFlowDirection.Bidirectional)
    "Partial model, to be replaced with a fluid component"
    annotation (Placement(transformation(extent={{-60,-10},{-40,10}})));
  replaceable IBPSA.Fluid.Interfaces.PartialTwoPortInterface res2
    constrainedby IBPSA.Fluid.Interfaces.PartialTwoPortInterface(redeclare
      final package Medium = Medium, allowFlowReversal=portFlowDirection_2 ==
        Modelica.Fluid.Types.PortFlowDirection.Bidirectional)
    "Partial model, to be replaced with a fluid component"
    annotation (Placement(transformation(extent={{60,-10},{40,10}})));
  replaceable IBPSA.Fluid.Interfaces.PartialTwoPortInterface res3
    constrainedby IBPSA.Fluid.Interfaces.PartialTwoPortInterface(redeclare
      final package Medium = Medium, allowFlowReversal=portFlowDirection_3 ==
        Modelica.Fluid.Types.PortFlowDirection.Bidirectional)
...
<code>IBPSA.Fluid.Examples.ResistanceVolumeFlowReversal</code> fails to simulate.
</li>
<li>
