within BuildSysPro.IBPSA.Fluid.BaseClasses.Validation;
model ActuatorFilter "Validation model for the actuator filter"
  ...
  IBPSA.Fluid.BaseClasses.ActuatorFilter act_1(f=fCut, initType=Modelica.Blocks.Types.Init.InitialState)
    "Filter with u_nominal not set"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  IBPSA.Fluid.BaseClasses.ActuatorFilter act_2(f=fCut, initType=Modelica.Blocks.Types.Init.InitialState)
  ...
  IBPSA.Fluid.BaseClasses.ActuatorFilter act_y_start05(
    f=fCut,
    initType=Modelica.Blocks.Types.Init.InitialOutput,
    y_start=0.5) "Filter with initial start value for output"
    annotation (Placement(transformation(extent={{20,60},{40,80}})));
  IBPSA.Fluid.BaseClasses.ActuatorFilter act_y_start1(
    f=fCut,
    initType=Modelica.Blocks.Types.Init.InitialOutput,
...
equation
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Fluid/BaseClasses/Validation/ActuatorFilter.mos"
        "Simulate and plot"),
    experiment(
      StopTime=20,
      Tolerance=1e-06),
...
<a href=\"modelica://BuildSysPro.IBPSA.Fluid.BaseClasses.ActuatorFilter\">
IBPSA.Fluid.BaseClasses.ActuatorFilter</a>.
