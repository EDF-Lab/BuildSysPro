...
model Basic "Example implementation of flow system"
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop pipSouth2(
    ...
    m_flow_nominal=3) "Pipe 2 to south of building" annotation (Placement(
        ...
        rotation=90,
        origin={-40,18})));
  IBPSA.Fluid.Movers.FlowControlled_dp pmpNorth(
    redeclare package Medium = Medium,
    redeclare replaceable
      IBPSA.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Pump to north of building" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={60,-20})));
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop pipNorth1(
    ...
    m_flow_nominal=3) "Pipe 1 to north of building" annotation (Placement(
        ...
        rotation=90,
        origin={40,18})));
  IBPSA.Fluid.Actuators.Valves.TwoWayLinear[4] valSouth1(
    ...
    each m_flow_nominal=1) "Valves on souther tabs section 1" annotation (
      Placement(transformation(
        ...
        rotation=270,
        origin={-80,60})));
  IBPSA.Fluid.Actuators.Valves.TwoWayLinear[8] valSouth2(
    each dpFixed_nominal=0,
    each CvData=IBPSA.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    each m_flow_nominal=1) "Valves on souther tabs section 2" annotation (
      Placement(transformation(
        ...
        rotation=270,
        origin={-40,60})));
  IBPSA.Fluid.Actuators.Valves.TwoWayLinear[4] valNorth1(
    each dpFixed_nominal=0,
    each CvData=IBPSA.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
    each m_flow_nominal=1) "Valves on northern tabs section 1" annotation (
      Placement(transformation(
        ...
        rotation=270,
        origin={40,60})));
  IBPSA.Fluid.Actuators.Valves.TwoWayLinear[8] valNorth2(
    each dpFixed_nominal=0,
    each CvData=IBPSA.Fluid.Types.CvTypes.OpPoint,
    each dpValve_nominal=8e4,
    redeclare each package Medium = Medium,
  ...
  IBPSA.Fluid.Actuators.Valves.ThreeWayLinear valSouth(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-60,-50})));
  IBPSA.Fluid.Actuators.Valves.ThreeWayLinear valNorth(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    dpFixed_nominal={20000,0},
    from_dp=true,
  ...
  IBPSA.Fluid.FixedResistances.Junction spl2(
    m_flow_nominal={10,10,10},
    dp_nominal={1000,10,10},
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) "Splitter"
  ...
  IBPSA.Fluid.FixedResistances.PressureDrop tabsSouth1[4](
    redeclare each package Medium = Medium,
    ...
    "Pressure drop of southern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-80,90})));
  IBPSA.Fluid.FixedResistances.PressureDrop tabsSouth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of southern tabs sections on collector 2" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-40,90})));
  IBPSA.Fluid.FixedResistances.PressureDrop tabsNorth1[4](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
    ...
    "Pressure drop of northern tabs sections on collector 1" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={40,90})));
  IBPSA.Fluid.FixedResistances.PressureDrop tabsNorth2[8](
    redeclare each package Medium = Medium,
    each dp_nominal=50000,
