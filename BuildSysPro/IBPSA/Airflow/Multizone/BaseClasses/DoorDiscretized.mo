...
partial model DoorDiscretized
  ...
  extends IBPSA.Airflow.Multizone.BaseClasses.TwoWayFlowElementBuoyancy;
...
equation
  ...
  for i in 1:nCom loop
    ...
    dVAB_flow[i] = dV_flow[i]*IBPSA.Utilities.Math.Functions.smoothHeaviside(x=
      dV_flow[i], delta=VZer_flow/nCom) + VZer_flow/nCom;
