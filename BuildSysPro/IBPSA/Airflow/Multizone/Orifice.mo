...
model Orifice "Orifice"
  extends IBPSA.Airflow.Multizone.Coefficient_V_flow(m=0.5, final C=CD*A*sqrt(
        2.0/rho_default));
...
<li>Michael Wetter.
<a href=\"modelica://BuildSysPro/IBPSA/Resources/Images/Airflow/Multizone/Wetter-airflow-2006.pdf\">Multizone Airflow Model in Modelica.</a>
