...
model ThreeRoomsContamDiscretizedDoor
  ...
  extends IBPSA.Airflow.Multizone.Validation.ThreeRoomsContam(redeclare
...
experiment(Tolerance=1e-06, StopTime=3600),
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Airflow/Multizone/Validation/ThreeRoomsContamDiscretizedDoor.mos"
        "Simulate and plot"),
