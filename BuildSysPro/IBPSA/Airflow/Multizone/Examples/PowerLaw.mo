...
model PowerLaw "Model with powerlaw models"
  ...
  IBPSA.Fluid.Sources.Boundary_pT roo2(
    ...
    use_p_in=true,
    nPorts=1,
    T=293.15) "Room 2" annotation (Placement(transformation(
        origin={90,70},
        extent={{-10,-10},{10,10}},
        rotation=180)));
...
experiment(
      StopTime=1,
      Tolerance=1e-06),
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Airflow/Multizone/Examples/PowerLaw.mos"
        "Simulate and plot"),
