...
model TrickleVent
  ...
  IBPSA.Airflow.Multizone.Table_m_flow tabDat_m_flow(
    redeclare package Medium = Medium,
    dpMea_nominal={-50,-25,-10,-5,-3,-2,-1,0,1,2,3,4.5,50},
    mMea_flow_nominal={-0.08709,-0.06158,-0.03895,-0.02754,-0.02133,-0.01742,-0.01232,
        0,0.01232,0.01742,0.02133,0.02613,0.02614})
    "Self regulating trickle vent"
    annotation (Placement(transformation(extent={{-20,-40},{0,-20}})));
  IBPSA.Airflow.Multizone.Table_V_flow tabDat_V_flow(
    redeclare package Medium = Medium,
    dpMea_nominal={-50,-25,-10,-5,-3,-2,-1,0,1,2,3,4.5,50},
    VMea_flow_nominal={-0.104508,-0.073896,-0.04674,-0.033048,-0.025596,-0.020904,
        -0.014784,0,0.014784,0.020904,0.025596,0.031356,0.031368})
    "Self regulating trickle vent"
...
equation
  ...
  annotation (__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Airflow/Multizone/Examples/TrickleVent.mos"
        "Simulate and plot"),
        experiment(
      StopTime=2592000,
      Interval=600,
...
<a href=\"modelica://BuildSysPro.IBPSA.Airflow.Multizone.Table_V_flow\">
IBPSA.Airflow.Multizone.Table_V_flow</a>
and
<a href=\"modelica://BuildSysPro.IBPSA.Airflow.Multizone.Table_m_flow\">
IBPSA.Airflow.Multizone.Table_m_flow</a>
