...
equation
  ...
  annotation (__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Airflow/Multizone/Examples/PressurizationData.mos"
        "Simulate and plot"),
        experiment(
      StopTime=2592000,
      Tolerance=1e-06),
...
<a href=\"modelica://BuildSysPro.IBPSA.Airflow.Multizone.Point_m_flow\">
