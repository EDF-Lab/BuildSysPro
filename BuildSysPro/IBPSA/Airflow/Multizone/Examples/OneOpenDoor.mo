...
model OneOpenDoor "Model with one open and one closed door"
  ...
  IBPSA.Airflow.Multizone.DoorDiscretizedOpen dooOpe(redeclare package
              Medium =
  ...
  IBPSA.Airflow.Multizone.DoorDiscretizedOperable dooOpeClo(redeclare package
              Medium =
...
equation
  ...
  connect(volB.ports[4], dooOpeClo.port_a2) annotation (Line(
      ...
      color={0,127,255}));
  annotation (
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Airflow/Multizone/Examples/OneOpenDoor.mos"
        "Simulate and plot"),
    experiment(
      StopTime=7200,
      Tolerance=1e-06),
