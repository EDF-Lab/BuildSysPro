...
model EffectiveAirLeakageArea "Effective air leakage area"
  extends IBPSA.Airflow.Multizone.Coefficient_V_flow(m=0.65, final C=L*CDRat*
        sqrt(2.0/rho_default)*dpRat^(0.5 - m));
...
<li>Michael Wetter. <a href=\"modelica://BuildSysPro/IBPSA/Resources/Images/Airflow/Multizone/Wetter-airflow-2006.pdf\">Multizone Airflow Model in Modelica.</a> Proc. of the 5th International Modelica Conference, p. 431-440. Vienna, Austria, September 2006. </li>
</ul>
</html>",
revisions="<html>
<ul>
