...
equation
  ...
  connect(sine.y, TBC.T) annotation (Line(
      points={{-59,70},{-2,70}},
      color={0,0,127}));
 annotation (                      __Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Controls/Continuous/Examples/PIDHysteresisTimer.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img src=\"modelica://BuildSysPro/Resources/IBPSA/Images/Controls/Continuous/Examples/PIDHysteresisTimerError.png\" border=\"1\" alt=\"Control error.\"/><br/>
<img src=\"modelica://BuildSysPro/Resources/IBPSA/Images/Controls/Continuous/Examples/PIDHysteresisTimerOutput.png\" border=\"1\" alt=\"Control signal.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
