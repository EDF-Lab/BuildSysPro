...
model SupplyReturnTemperatureReset "Test model for the heating curve"
  ...
  IBPSA.Controls.SetPoints.SupplyReturnTemperatureReset heaCur1(
    ...
    TRet_nominal=313.15,
    TOut_nominal=263.15,
    dTOutHeaBal=15) "Temperature reset that uses room temperature as input"
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Controls/SetPoints/Examples/SupplyReturnTemperatureReset.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img src=\"modelica://BuildSysPro/IBPSA/Resources/Images/Controls/SetPoints/Examples/SupplyReturnTemperatureReset.png\" border=\"1\" alt=\"Supply and return water temperatures.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
