...
model Table "Test model for table that determines set points"
  ...
  IBPSA.Controls.SetPoints.Table tabConExt(table=[20,0; 22,0.5; 25,0.5;
        26,1])
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Controls/SetPoints/Examples/Table.mos"
        "Simulate and plot"),
