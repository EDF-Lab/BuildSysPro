within BuildSysPro.IBPSA.Controls.SetPoints.Validation;
model OccupancySchedulePositiveStartTime
  ...
  annotation (experiment(
      ...
      StopTime=207360,
      Tolerance=1e-06),
    __Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Controls/SetPoints/Validation/OccupancySchedulePositiveStartTime.mos"
        "Simulate and plot"),
