...
model DecemberToJanuary
  ...
  IBPSA.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam=Modelica.Utilities.Files.loadResource(
        "modelica://BuildSysPro/IBPSA/Resources/Data/BoundaryConditions/WeatherData/Validation/DecemberToJanuary.mos"))
  ...
  annotation (experiment(
      ...
      Interval=3600,
      Tolerance=1e-006),
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/Validation/DecemberToJanuary.mos"
        "Simulate and plot"),
