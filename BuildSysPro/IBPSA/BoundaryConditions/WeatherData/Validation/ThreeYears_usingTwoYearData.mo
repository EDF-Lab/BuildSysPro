within BuildSysPro.IBPSA.BoundaryConditions.WeatherData.Validation;
model ThreeYears_usingTwoYearData
  ...
  IBPSA.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam=Modelica.Utilities.Files.loadResource(
        "modelica://BuildSysPro/IBPSA/Resources/Data/BoundaryConditions/WeatherData/Validation/TwoYears_DataOnceAMonth_TMY3.mos"))
  ...
  annotation (experiment(
      StopTime=94608000,
      Tolerance=1e-006),
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/Validation/ThreeYears_usingTwoYearData.mos"
        "Simulate and plot"),
