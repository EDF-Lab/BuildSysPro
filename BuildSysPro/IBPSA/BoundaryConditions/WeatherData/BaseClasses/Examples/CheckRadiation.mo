...
model CheckRadiation "Test model for CheckRadiation"
  extends
    IBPSA.BoundaryConditions.WeatherData.BaseClasses.Examples.ConvertRadiation;
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.CheckRadiation cheGloRad
    "Check global horizontal radiation"
    annotation (Placement(transformation(extent={{60,20},{80,40}})));
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.CheckRadiation cheDifRad
...
__Dymola_Commands(file=
          "modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckRadiation.mos"
        "Simulate and plot"));
end CheckRadiation;
