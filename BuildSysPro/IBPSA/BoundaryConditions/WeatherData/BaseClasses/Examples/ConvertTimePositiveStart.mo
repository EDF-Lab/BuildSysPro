...
model ConvertTimePositiveStart
  ...
  extends
    IBPSA.BoundaryConditions.WeatherData.BaseClasses.Examples.ConvertTime;
  annotation (
...
__Dymola_Commands(file=
          "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/ConvertTimePositiveStart.mos"
        "Simulate and plot"));
