...
model CheckSkyCover "Test model for checking sky cover"
  ...
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.CheckSkyCover cheTotSkyCov
    "Check total sky cover"
    annotation (Placement(transformation(extent={{60,20},{80,40}})));
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.CheckSkyCover cheOpaSkyCov
    "Check opaque sky cover"
    annotation (Placement(transformation(extent={{60,-20},{80,0}})));
protected
  IBPSA.Utilities.Time.ModelTime modTim "Generate simulation time"
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckSkyCover.mos"
        "Simulate and plot"));
end CheckSkyCover;
