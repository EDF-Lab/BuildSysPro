...
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  Modelica.Blocks.Interfaces.RealInput TBlaSky_in(
    final quantity="ThermodynamicTemperature",
    displayUnit="degC",
    final unit="K") if (TBlaSkySou == IBPSA.BoundaryConditions.Types.DataSource.Input)
    "Black-body sky temperature"
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildSysPro/Resources/IBPSA/Images/BoundaryConditions/WeatherData/RadiationTimeShift.png\"
border=\"1\" />
</p>
<h4>References</h4>
<ul>
