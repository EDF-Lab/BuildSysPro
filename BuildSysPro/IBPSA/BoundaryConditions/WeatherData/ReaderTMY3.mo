within BuildSysPro.IBPSA.BoundaryConditions.WeatherData;
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  Modelica.Blocks.Interfaces.RealInput pAtm_in(
    ...
    final unit="Pa",
    displayUnit="Pa")
    if (pAtmSou == IBPSA.BoundaryConditions.Types.DataSource.Input)
    "Input pressure"
  ...
  Modelica.Blocks.Interfaces.RealInput TDryBul_in(
    ...
    final unit="K",
    displayUnit="degC")
    if (TDryBulSou == IBPSA.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput TDewPoi_in(
    ...
    final unit="K",
    displayUnit="degC")
    if (TDewPoiSou == IBPSA.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput TBlaSky_in(
    ...
    displayUnit="degC",
    final unit="K")
    if (TBlaSkySou == IBPSA.BoundaryConditions.Types.DataSource.Input)
    "Black-body sky temperature"
  ...
  Modelica.Blocks.Interfaces.RealInput winDir_in(
    ...
    final unit="rad",
    displayUnit="deg")
    if (winDirSou == IBPSA.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput HInfHor_in(
    ...
    final unit="W/m2")
    if (HInfHorSou == IBPSA.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput HDifHor_in(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2") if (HSou == IBPSA.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor
     or HSou == IBPSA.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor)
...
//--------------------------------------------------------------
  ...
  Modelica.Blocks.Interfaces.RealInput ceiHei_in(
    ...
    final unit="m",
    displayUnit="m")
    if (ceiHeiSou == IBPSA.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput totSkyCov_in(
    ...
    max=1,
    unit="1")
    if (totSkyCovSou == IBPSA.BoundaryConditions.Types.DataSource.Input)
  ...
  Modelica.Blocks.Interfaces.RealInput opaSkyCov_in(
    ...
    max=1,
    unit="1")
    if (opaSkyCovSou == IBPSA.BoundaryConditions.Types.DataSource.Input)
  ...
  final parameter Modelica.Units.SI.Angle lon(displayUnit="deg")=
    IBPSA.BoundaryConditions.WeatherData.BaseClasses.getLongitudeTMY3(filNam)
    "Longitude";
  final parameter Modelica.Units.SI.Angle lat(displayUnit="deg")=
    IBPSA.BoundaryConditions.WeatherData.BaseClasses.getLatitudeTMY3(filNam)
    "Latitude";
  ...
  final parameter Modelica.Units.SI.Length alt(displayUnit="m")=
    IBPSA.BoundaryConditions.WeatherData.BaseClasses.getAltitudeLocationTMY3(
...
protected
  ...
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.CheckDewPointTemperature cheTemDewPoi
  ...
  Modelica.Blocks.Math.Gain conRelHum(final k=0.01)
    if relHumSou == IBPSA.BoundaryConditions.Types.DataSource.File
  ...
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.LimiterWindSpeed limWinSpe
    "Limits the wind speed"
    annotation (Placement(transformation(extent={{160,-80},{180,-60}})));
  IBPSA.BoundaryConditions.WeatherData.BaseClasses.LimiterHorizontalInfraredIrradiation
  ...
  SkyTemperature.BlackBody TBlaSkyCom(final calTSky=calTSky)
    if TBlaSkySou == IBPSA.BoundaryConditions.Types.DataSource.File
  ...
  IBPSA.Utilities.Psychrometrics.TWetBul_TDryBulPhi tWetBul_TDryBulXi(
      redeclare package Medium = IBPSA.Media.Air, TDryBul(displayUnit="degC"))
  ...
  Modelica.Blocks.Math.Gain conTotSkyCov(final k=0.1)
    if totSkyCovSou == IBPSA.BoundaryConditions.Types.DataSource.File
    "Convert sky cover from [0...10] to [0...1]"
    annotation (Placement(transformation(extent={{40,-40},{60,-20}})));
  Modelica.Blocks.Math.Gain conOpaSkyCov(final k=0.1)
    if opaSkyCovSou == IBPSA.BoundaryConditions.Types.DataSource.File
    "Convert sky cover from [0...10] to [0...1]"
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://BuildSysPro/IBPSA/Resources/Images/BoundaryConditions/WeatherData/RadiationTimeShift.png\"
border=\"1\" />
</p>
<h4>References</h4>
<ul>
...
<code>Modelica.Utilities.Files.loadResource(\"modelica://BuildSysPro/IBPSA/Resources/weatherdata/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos\")</code>
should be used.<br/>
This is for
