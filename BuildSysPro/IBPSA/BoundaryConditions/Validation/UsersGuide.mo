within BuildSysPro.IBPSA.BoundaryConditions.Validation;
package UsersGuide
  "User's Guide"
  ...
  annotation (
    ...
    Documentation(
      info="<html>
<p>
The package <a href=\"modelica://BuildSysPro.IBPSA.BoundaryConditions.Validation.BESTEST\">IBPSA.BoundaryConditions.Validation.BESTEST</a>
...
<li>
<a href=\"modelica://BuildSysPro.IBPSA.BoundaryConditions.SkyTemperature.BlackBody\">Sky black body temperature</a>
calculated using Horizontal radiation or dew point temperature and sky cover.
</li>
<li>Diffused radiation calculated using <a href=\"modelica://BuildSysPro.IBPSA.BoundaryConditions.SolarIrradiation.DiffusePerez\">Perez</a> and
<a href=\"modelica://BuildSysPro.IBPSA.BoundaryConditions.SolarIrradiation.DiffuseIsotropic\">Isotropic</a> sky models</li>
</ul>
