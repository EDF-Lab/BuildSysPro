...
model WD400
  ...
  extends WD100(
    ...
    weaDatHHorIR(
      filNam=Modelica.Utilities.Files.loadResource(
        "modelica://BuildSysPro/IBPSA/Resources/Data/BoundaryConditions/Validation/BESTEST/WD400.mos")),
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/BoundaryConditions/Validation/BESTEST/WD400.mos" "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
<li>
