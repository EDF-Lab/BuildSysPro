within BuildSysPro.IBPSA.BoundaryConditions.Validation.BESTEST;
model WD100
  ...
  WeatherData.ReaderTMY3 weaDatHHorIR(
    ...
    filNam=Modelica.Utilities.Files.loadResource(
      "modelica://BuildSysPro/IBPSA/Resources/Data/BoundaryConditions/Validation/BESTEST/WD100.mos"),
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/BoundaryConditions/Validation/BESTEST/WD100.mos" "Simulate and plot"),
    Documentation(
      info="<html>
...
The model
<a href=\"modelica://BuildSysPro.IBPSA.BoundaryConditions.Validation.IsotropicAndPerezDiffuseRadiation\">IBPSA.BoundaryConditions.Validation.IsotropicAndPerezDiffuseRadiation</a>
