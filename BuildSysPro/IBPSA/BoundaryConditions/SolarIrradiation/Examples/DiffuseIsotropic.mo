within BuildSysPro.IBPSA.BoundaryConditions.SolarIrradiation.Examples;
model DiffuseIsotropic
  ...
  IBPSA.BoundaryConditions.SolarIrradiation.DiffuseIsotropic HDifRoo(til=IBPSA.Types.Tilt.Ceiling,
      rho=rho) "Diffuse irradiation on roof"
    annotation (Placement(transformation(extent={{40,0},{60,20}})));
  IBPSA.BoundaryConditions.SolarIrradiation.DiffuseIsotropic HDifFlo(til=IBPSA.Types.Tilt.Floor,
      rho=rho) "Diffuse irradiation on floor"
    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
  IBPSA.BoundaryConditions.SolarIrradiation.DiffuseIsotropic HDifWal(til=IBPSA.Types.Tilt.Wall,
