...
model BrighteningCoefficient "Test model for brightening coeffcients"
  ...
  IBPSA.BoundaryConditions.SolarGeometry.ZenithAngle zen(lat=0.6457718232379)
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/BoundaryConditions/SolarIrradiation/BaseClasses/Examples/BrighteningCoefficient.mos" "run"));
