...
model AltitudeAngle "Test model for altitude angle"
  ...
  IBPSA.BoundaryConditions.SolarGeometry.BaseClasses.ZenithAngle zen(lat=
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/AltitudeAngle.mos"
        "Simulate and plot"),
