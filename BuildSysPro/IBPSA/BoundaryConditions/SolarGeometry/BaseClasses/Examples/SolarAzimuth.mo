...
model SolarAzimuth "Test model for zenith angle"
  ...
  IBPSA.BoundaryConditions.SolarGeometry.BaseClasses.SolarAzimuth solAzi
    "Solar azimuth"
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/SolarAzimuth.mos"
        "Simulate and plot"));
end SolarAzimuth;
