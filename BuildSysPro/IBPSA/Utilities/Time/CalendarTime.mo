within BuildSysPro.IBPSA.Utilities.Time;
model CalendarTime
...
initial algorithm
  ...
  if zerTim == IBPSA.Utilities.Time.Types.ZeroTime.UnixTimeStamp then
    timOff :=0;
  elseif zerTim == IBPSA.Utilities.Time.Types.ZeroTime.UnixTimeStampGMT then
    timOff :=timZon;
...
(see <a href=\"modelica://BuildSysPro.IBPSA.BoundaryConditions.WeatherData.ReaderTMY3\">
IBPSA.BoundaryConditions.WeatherData.ReaderTMY3</a>)
