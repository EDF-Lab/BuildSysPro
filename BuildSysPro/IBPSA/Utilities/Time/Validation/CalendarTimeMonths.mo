...
model CalendarTimeMonths "Validation model for the calendar time model"
  ...
  IBPSA.Utilities.Time.CalendarTime calTim(zerTim=IBPSA.Utilities.Time.Types.ZeroTime.NY2015)
...
equation
  ...
  annotation (
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Utilities/Time/Validation/CalendarTimeMonths.mos"
        "Simulate and plot"),
  Documentation(
    info="<html>
<p>
