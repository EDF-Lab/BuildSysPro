...
algorithm
  if n > 2 then
    ...
    dy_dx := IBPSA.Utilities.Math.Functions.splineDerivatives(
      x=xSup,
      y=ySup,
...
<a href=\"modelica://BuildSysPro.IBPSA.Utilities.Math.Functions.Examples.SmoothInterpolation\">
IBPSA.Utilities.Math.Functions.Examples.SmoothInterpolation</a>.
</p>
</html>",
revisions="<html>
<ul>
