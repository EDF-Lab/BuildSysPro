...
equation
  ...
  for k in 1:10 loop
    falFac[k] = IBPSA.Utilities.Math.Functions.fallingFactorial(n, k);
  end for;

  annotation (
    __Dymola_Commands(file=
          "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/FallingFactorial.mos"
        "Simulate and plot"),
