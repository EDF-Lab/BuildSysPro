within BuildSysPro.IBPSA.Utilities.Math;
block IntegratorWithReset "Output the integral of the input signal"
  ...
  */
  ...
  parameter Real y_reset = 0
    "Value to which integrator is reset, used if reset = IBPSA.Types.Reset.Parameter"
    annotation(Evaluate=true,
               Dialog(
...
equation
  ...
  if reset == IBPSA.Types.Reset.Disabled then
