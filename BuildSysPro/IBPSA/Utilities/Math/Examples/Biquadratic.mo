...
model Biquadratic "Test model for biquadratic function"
  ...
  IBPSA.Utilities.Math.Biquadratic biquadratic(a={1,2,3,4,5,6})
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Utilities/Math/Examples/Biquadratic.mos"
        "Simulate and plot"),
