...
model Average "Test model for average function"
  ...
  IBPSA.Utilities.Math.Average average(nin=2)
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Utilities/Math/Examples/Average.mos"
