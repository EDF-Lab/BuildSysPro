...
model IntegratorWithReset "Test model for integrator with reset"
  ...
  IBPSA.Utilities.Math.IntegratorWithReset intWitRes1(
    y_start=5,
  ...
  IBPSA.Utilities.Math.IntegratorWithReset intWitRes2(
    y_reset=10,
    y_start=-5,
  ...
  IBPSA.Utilities.Math.IntegratorWithReset intNoReset(
  ...
  IBPSA.Utilities.Math.IntegratorWithReset intDef
...
<a href=\"modelica://BuildSysPro.IBPSA.Utilities.Math.IntegratorWithReset\">
IBPSA.Utilities.Math.IntegratorWithReset</a>
