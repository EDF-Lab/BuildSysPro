within BuildSysPro.IBPSA.Utilities.IO.Files.BaseClasses;
...
extends ExternalObject;
  function constructor
    ...
    annotation (
      ...
      IncludeDirectory="modelica://BuildSysPro/Resources/C-Sources");

    annotation(Documentation(info="<html>
<p>
Creates an empty file with name <code>fileName</code>.
If <code>fileName</code> is used in another instance of
<a href=\"modelica://BuildSysPro.IBPSA.Utilities.IO.Files.CSVWriter\">
