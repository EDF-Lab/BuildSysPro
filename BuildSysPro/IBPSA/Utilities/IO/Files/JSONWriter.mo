...
model JSONWriter "Model for writing results to a json file"
  ...
  parameter IBPSA.Utilities.IO.Files.BaseClasses.OutputTime outputTime=IBPSA.Utilities.IO.Files.BaseClasses.OutputTime.Terminal
    "Time when results are written to file" annotation (Evaluate=true);
