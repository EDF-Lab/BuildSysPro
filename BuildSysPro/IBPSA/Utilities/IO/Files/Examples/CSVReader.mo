...
model CSVReader "Reader for csv files generated by CSVWriter"
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(
    tableOnFile=true,
    fileName=Modelica.Utilities.Files.loadResource("modelica://BuildSysPro/IBPSA//Resources/Data/Utilities/IO/Files/Examples/CSVReader/Data.txt"),
    columns={2,3},
  ...
  annotation (
    ...
    experiment(
      ...
      StopTime=10,
      Tolerance=1e-06),
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Utilities/IO/Files/Examples/CSVReader.mos"
        "Simulate and plot"),
...
<code>IBPSA//Resources/Data/Utilities/IO/Files/Examples/CSVReader/Data.txt</code>.
It has the format of a file that can be generated by
<a href=\"modelica://BuildSysPro.IBPSA.Utilities.IO.Files.Examples.CSVWriter\">
IBPSA.Utilities.IO.Files.Examples.CSVWriter</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
