within BuildSysPro.IBPSA.Utilities.IO.Files.Examples;
model JSONWriter "Example use of the JSON writer"
  ...
  IBPSA.Utilities.IO.Files.JSONWriter jsonWriterOneVar(nin=1, fileName=
        "TerminalOutput.json") "Single variable output"
...
See <a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/1114\">#1114</a>.
    ...
    experiment(
      StopTime=2,
      Tolerance=1e-06),
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Utilities/IO/Files/Examples/JSONWriter.mos"
        "Simulate and plot"));
end JSONWriter;
