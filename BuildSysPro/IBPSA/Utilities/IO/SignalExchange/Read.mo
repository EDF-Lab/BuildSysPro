...
model Read "Block that allows a signal to be read as an FMU output"
  ...
  parameter String zone = "1" if (KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.AirZoneTemperature
     or KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.RadiativeZoneTemperature
     or KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.OperativeZoneTemperature
     or KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.RelativeHumidity
     or KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.CO2Concentration)
    ...
    or CO2Concentration"
  annotation(Dialog(enable=(KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.AirZoneTemperature
           or KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.RadiativeZoneTemperature
           or KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.OperativeZoneTemperature
           or KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.RelativeHumidity
           or KPIs == IBPSA.Utilities.IO.SignalExchange.SignalTypes.SignalsForKPIs.CO2Concentration)));
