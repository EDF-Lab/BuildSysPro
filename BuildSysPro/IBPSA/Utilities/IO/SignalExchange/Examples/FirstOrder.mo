within BuildSysPro.IBPSA.Utilities.IO.SignalExchange.Examples;
model FirstOrder
...
equation
  ...
  __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Utilities/IO/SignalExchange/Examples/FirstOrder.mos"
        "Simulate and plot"),
Documentation(info="<html>
<p>
This example uses the signal exchange blocks in an original model,
<a href=\"modelica://BuildSysPro.IBPSA.Utilities.IO.SignalExchange.Examples.BaseClasses.OriginalModel\">
IBPSA.Utilities.IO.SignalExchange.Examples.BaseClasses.OriginalModel</a>
along with a corresponding model that would result if the original model were
compiled with the BOPTEST parser, <a href=\"modelica://BuildSysPro.IBPSA.Utilities.IO.SignalExchange.Examples.BaseClasses.ExportedModel\">
IBPSA.Utilities.IO.SignalExchange.Examples.BaseClasses.ExportedModel</a>
