...
model WeatherStation "Example use of WeatherStation"
  ...
  IBPSA.Utilities.IO.SignalExchange.WeatherStation weaSta "Weather station"
...
equation
  ...
  __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Utilities/IO/SignalExchange/Examples/WeatherStation.mos"
        "Simulate and plot"),
Documentation(info="<html>
<p>
This example uses the weather station signal exchange block,
<a href=\"modelica://BuildSysPro.IBPSA.Utilities.IO.SignalExchange.WeatherStation\">
IBPSA.Utilities.IO.SignalExchange.WeatherStation</a>
