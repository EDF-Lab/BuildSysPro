within BuildSysPro.IBPSA.Utilities.Clustering.Validation;
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Utilities/Clustering/Validation/KMeans_1d.mos"
        "Simulate and plot"),
