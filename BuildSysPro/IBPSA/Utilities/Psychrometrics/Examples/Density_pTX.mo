...
model Density_pTX "Model to test the density computation"
 ...
 package Medium = IBPSA.Media.Air "Medium model"
  ...
  IBPSA.Utilities.Psychrometrics.Density_pTX den "Density"
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Utilities/Psychrometrics/Examples/Density_pTX.mos"
        "Simulate and plot"),
