...
model HumidityRatioPressure "Unit test for humidity ratio model"
 ...
 package Medium = IBPSA.Media.Air "Medium model"
  ...
  Modelica.Blocks.Sources.Constant p(k=101325) "Pressure"
            ...
            {-60,40}})));
  IBPSA.Utilities.Psychrometrics.X_pW humRat(use_p_in=true)
...
__Dymola_Commands(file="modelica://BuildSysPro/Resources/IBPSA/Scripts/Dymola/Utilities/Psychrometrics/Examples/HumidityRatioPressure.mos"
        "Simulate and plot"));
