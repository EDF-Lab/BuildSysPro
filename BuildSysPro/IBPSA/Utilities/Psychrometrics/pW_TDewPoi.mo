...
equation
  p_w = IBPSA.Utilities.Psychrometrics.Functions.pW_TDewPoi_amb(T=T);
    annotation (
...
in
<a href=\"modelica://BuildSysPro.IBPSA.Utilities.Psychrometrics.Functions.pW_TDewPoi\">
IBPSA.Utilities.Psychrometrics.Functions.pW_TDewPoi</a>.
...
<code>p_w = IBPSA.Utilities.Psychrometrics.Functions.pW_TDewPoi(T=T);</code>
to
<code>p_w = IBPSA.Utilities.Psychrometrics.Functions.pW_TDewPoi_amb(T=T);</code>
