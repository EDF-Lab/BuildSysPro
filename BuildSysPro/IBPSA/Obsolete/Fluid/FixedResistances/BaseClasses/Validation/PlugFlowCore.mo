within BuildSysPro.IBPSA.Obsolete.Fluid.FixedResistances.BaseClasses.Validation;
...
equation
  ...
  annotation (
    __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Obsolete/Fluid/FixedResistances/BaseClasses/Validation/PlugFlowCore.mos"
        "Simulate and Plot"),
    experiment(StopTime=1000, Tolerance=1e-006),
    Documentation(info="<html>
<p>
Basic test of model
<a href=\"modelica://BuildSysPro.IBPSA.Obsolete.Fluid.FixedResistances.BaseClasses.PlugFlowCore\">
