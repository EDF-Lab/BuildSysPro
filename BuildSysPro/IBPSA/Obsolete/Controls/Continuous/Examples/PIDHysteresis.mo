...
equation
  ...
  connect(sine.y, TBC.T) annotation (Line(
      points={{-59,70},{-2,70}},
      color={0,0,127}));
 annotation (                      __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Obsolete/Controls/Continuous/Examples/PIDHysteresis.mos"
        "Simulate and plot"),
...
<p align=\"center\">
<img src=\"modelica://BuildSysPro/IBPSA/Resources/Images/Obsolete/Controls/Continuous/Examples/PIDHysteresis.png\" border=\"1\" alt=\"Control error.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
