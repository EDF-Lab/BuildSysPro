within BuildSysPro.IBPSA.Obsolete.Controls.Continuous.Examples;
model PIDHysteresisTimer
  "Example model for PID controller with hysteresis and timer"
  extends Modelica.Icons.Example;

  IBPSA.Obsolete.Controls.Continuous.PIDHysteresisTimer con(
    yMin=0.3,
    minOffTime=10000,
    Ti=60,
...
equation
  ...
  connect(sine.y, TBC.T) annotation (Line(
      points={{-59,70},{-2,70}},
      color={0,0,127}));
 annotation (                      __Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Obsolete/Controls/Continuous/Examples/PIDHysteresisTimer.mos"
        "Simulate and plot"),
...
<a href=\"modelica://BuildSysPro.IBPSA.Obsolete.Controls.Continuous.Examples.PIDHysteresis\">
IBPSA.Obsolete.Controls.Continuous.Examples.PIDHysteresis</a>,
...
<p align=\"center\">
<img src=\"modelica://BuildSysPro/IBPSA/Resources/Images/Obsolete/Controls/Continuous/Examples/PIDHysteresisTimerError.png\" border=\"1\" alt=\"Control error.\"/><br/>
<img src=\"modelica://BuildSysPro/IBPSA/Resources/Images/Obsolete/Controls/Continuous/Examples/PIDHysteresisTimerOutput.png\" border=\"1\" alt=\"Control signal.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
