within BuildSysPro.IBPSA.ThermalZones.ReducedOrder.Examples;
model SimpleRoomFourElementsTraceSubstance
  "Illustrates the use of a thermal zone considering a trace substance"
  extends Modelica.Icons.Example;
  extends
    IBPSA.ThermalZones.ReducedOrder.Examples.SimpleRoomFourElements(
      thermalZoneFourElements(
      redeclare package Medium = Medium,
      use_C_flow=true,
      nPorts=2));

  replaceable package Medium = IBPSA.Media.Air (extraPropertiesNames={"C_flow"})
                                     "Medium model"
  ...
  IBPSA.Fluid.Sources.MassFlowSource_T souAir(
    ...
    nPorts=1) "Source of air" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-30,-70})));
...
First implementation.
  ...
  "modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Examples/SimpleRoomFourElementsTraceSubstance.mos"
        "Simulate and plot"),
