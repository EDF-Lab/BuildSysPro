within BuildSysPro.IBPSA.Media.Specialized.Water;
...
Renamed from <code>IBPSA.Media.Water</code> to
<code>IBPSA.Media.Water.Detailed</code> to allow addition of
<code>IBPSA.Media.Water.Simple</code>.
</li>
<li>
