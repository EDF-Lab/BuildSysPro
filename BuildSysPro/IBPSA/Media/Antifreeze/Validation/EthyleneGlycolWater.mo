within BuildSysPro.IBPSA.Media.Antifreeze.Validation;
model EthyleneGlycolWater
  "Model that tests the implementation of ethylene glycol-water properties"
  extends Modelica.Icons.Example;
  extends
    IBPSA.Media.Antifreeze.Validation.BaseClasses.FluidProperties(
    redeclare package Medium =
        IBPSA.Media.Antifreeze.Validation.BaseClasses.EthyleneGlycolWater (
...
__Dymola_Commands(file="modelica://BuildSysPro/IBPSA/Resources/Scripts/Dymola/Media/Antifreeze/Validation/EthyleneGlycolWater.mos"
        "Simulate and plot"),
