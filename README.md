...
### Release updates
Current release is version 2.0.0.
The whole documentation is now in English. This release provides an improved compatibility with OpenModelica, and other minor corrections.

The flow-based EDF library for fluid modelling is still work in progress and therefore not published yet.
...
BuildSysPro open source 2.0.0 is compatible with OpenModelica 1.9.3. When working with OpenModelica, specify your initial conditions carefully and use preferably Dassl, Euler or Runge-Kutta solvers.
